...
HD_PWD='/tmp/tmp.rETG9Rbw1g/temp/hwflow/hwflow_project_1/project_1.runs/project_1_m10_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1_m10_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1_m10_regslice_0.tcl

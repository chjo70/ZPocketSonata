...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module stats_num_diff_bit_cnt_V_rom (
...
initial begin
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram0);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram1);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram2);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram3);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram4);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram5);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram6);
    $readmemh("./stats_num_diff_bit_cnt_V_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module stats_num_diff_bit_cnt_V(
    reset,
    clk,
    address0,
    ce0,
...
stats_num_diff_bit_cnt_V_rom stats_num_diff_bit_cnt_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

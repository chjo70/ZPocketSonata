...
--               /tmp/tmp.rETG9Rbw1g/temp/hwflow/hwflow_project_1/project_1.srcs/sources_1/bd/project_1/ip/project_1_clk_wiz_0/project_1_clk_wiz_0_sim_netlist.vhdl
...
architecture STRUCTURE of project_1_clk_wiz_0_project_1_clk_wiz_0_clk_wiz is
  ...
  signal clk_out2_project_1_clk_wiz_0 : STD_LOGIC;
  signal clk_out3_project_1_clk_wiz_0 : STD_LOGIC;
...
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_project_1_clk_wiz_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_project_1_clk_wiz_0,
      O => clk_out3
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT1 => clk_out2_project_1_clk_wiz_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_project_1_clk_wiz_0,

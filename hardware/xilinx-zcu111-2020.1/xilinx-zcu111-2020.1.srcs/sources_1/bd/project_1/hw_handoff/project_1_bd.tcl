...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#PMU GPO 4#PMU GPO 5#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
  ...
  # Create instance: rst_PS_0_99M, and set properties
  set rst_PS_0_99M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_PS_0_99M ]
  ...
  set usp_rf_data_converter_0_i [ create_bd_cell -type ip -vlnv xilinx.com:ip:usp_rf_data_converter:2.3 usp_rf_data_converter_0_i ]
  set_property -dict [ list \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets src_data_broadcast_M00_AXIS] [get_bd_intf_pins enc_ip_probe/mon] [get_bd_intf_pins src_data_broadcast/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins PS_0/M_AXI_HPM0_FPD] [get_bd_intf_pins PS_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins PS_0/M_AXI_HPM1_FPD] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M00_AXI [get_bd_intf_pins PS_0_axi_periph/M00_AXI] [get_bd_intf_pins data_source/s_axi_CNTRL]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M01_AXI [get_bd_intf_pins PS_0_axi_periph/M01_AXI] [get_bd_intf_pins sd_fec_enc/S_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M02_AXI [get_bd_intf_pins PS_0_axi_periph/M02_AXI] [get_bd_intf_pins enc_ip_mon/s_axi_CNTRL]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M03_AXI [get_bd_intf_pins PS_0_axi_periph/M03_AXI] [get_bd_intf_pins enc_op_mon/s_axi_CNTRL]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M04_AXI [get_bd_intf_pins PS_0_axi_periph/M04_AXI] [get_bd_intf_pins sd_fec_dec/S_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M05_AXI [get_bd_intf_pins PS_0_axi_periph/M05_AXI] [get_bd_intf_pins stats/s_axi_CNTRL]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M06_AXI [get_bd_intf_pins PS_0_axi_periph/M06_AXI] [get_bd_intf_pins axi_gpio/S_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M07_AXI [get_bd_intf_pins PS_0_axi_periph/M07_AXI] [get_bd_intf_pins dec_ip_mon/s_axi_CNTRL]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M08_AXI [get_bd_intf_pins PS_0_axi_periph/M08_AXI] [get_bd_intf_pins dec_op_mon/s_axi_CNTRL]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M09_AXI [get_bd_intf_pins PS_0_axi_periph/M09_AXI] [get_bd_intf_pins gpio_reset/S_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_axi_periph_M10_AXI [get_bd_intf_pins PS_0_axi_periph/M10_AXI] [get_bd_intf_pins axi_intc/s_axi]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_PS_0_99M/interconnect_aresetn]
  ...
  connect_bd_net -net axi_intc_irq [get_bd_pins PS_0/pl_ps_irq0] [get_bd_pins axi_intc/irq]
  ...
  connect_bd_net -net clk_wiz_clk_out3 [get_bd_pins PS_0_axi_periph/ACLK] [get_bd_pins PS_0_axi_periph/M00_ACLK] [get_bd_pins PS_0_axi_periph/M01_ACLK] [get_bd_pins PS_0_axi_periph/M02_ACLK] [get_bd_pins PS_0_axi_periph/M03_ACLK] [get_bd_pins PS_0_axi_periph/M04_ACLK] [get_bd_pins PS_0_axi_periph/M05_ACLK] [get_bd_pins PS_0_axi_periph/M06_ACLK] [get_bd_pins PS_0_axi_periph/M07_ACLK] [get_bd_pins PS_0_axi_periph/M08_ACLK] [get_bd_pins PS_0_axi_periph/M09_ACLK] [get_bd_pins PS_0_axi_periph/M10_ACLK] [get_bd_pins adc_sink_i/s0_axis_clock] [get_bd_pins axi_gpio/s_axi_aclk] [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins clk_wiz/clk_out3] [get_bd_pins dac_source_i/m0_axis_clock] [get_bd_pins data_source/cntrl_aclk] [get_bd_pins dec_ip_mon/cntrl_aclk] [get_bd_pins dec_op_mon/cntrl_aclk] [get_bd_pins enc_ip_mon/cntrl_aclk] [get_bd_pins enc_op_mon/cntrl_aclk] [get_bd_pins gpio_reset/s_axi_aclk] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk] [get_bd_pins sd_fec_dec/s_axi_aclk] [get_bd_pins sd_fec_enc/s_axi_aclk] [get_bd_pins stats/cntrl_aclk] [get_bd_pins usp_rf_data_converter_0_i/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0_i/s0_axis_aclk]
  ...
  connect_bd_net -net emio_uart1_rxd_0_1 [get_bd_ports emio_uart1_rxd_0] [get_bd_pins PS_0/emio_uart1_rxd]
  ...
  connect_bd_net -net rst_PS_0_99M_peripheral_aresetn [get_bd_pins PS_0_axi_periph/S00_ARESETN] [get_bd_pins adc_sink_i/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins dac_source_i/s_axi_aresetn] [get_bd_pins rst_PS_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0_i/s_axi_aresetn]
  connect_bd_net -net rst_clk_wiz_100M_interconnect_aresetn [get_bd_pins PS_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins PS_0_axi_periph/M00_ARESETN] [get_bd_pins PS_0_axi_periph/M01_ARESETN] [get_bd_pins PS_0_axi_periph/M02_ARESETN] [get_bd_pins PS_0_axi_periph/M03_ARESETN] [get_bd_pins PS_0_axi_periph/M04_ARESETN] [get_bd_pins PS_0_axi_periph/M05_ARESETN] [get_bd_pins PS_0_axi_periph/M06_ARESETN] [get_bd_pins PS_0_axi_periph/M07_ARESETN] [get_bd_pins PS_0_axi_periph/M08_ARESETN] [get_bd_pins PS_0_axi_periph/M09_ARESETN] [get_bd_pins PS_0_axi_periph/M10_ARESETN] [get_bd_pins axi_gpio/s_axi_aresetn] [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins data_source/ap_rst_n_cntrl_aclk] [get_bd_pins dec_ip_mon/ap_rst_n_cntrl_aclk] [get_bd_pins dec_op_mon/ap_rst_n_cntrl_aclk] [get_bd_pins enc_ip_mon/ap_rst_n_cntrl_aclk] [get_bd_pins enc_op_mon/ap_rst_n_cntrl_aclk] [get_bd_pins gpio_reset/s_axi_aresetn] [get_bd_pins rst_clk_wiz_100M/peripheral_aresetn] [get_bd_pins stats/ap_rst_n_cntrl_aclk] [get_bd_pins usp_rf_data_converter_0_i/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0_i/s0_axis_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart1_txd [get_bd_ports emio_uart1_txd_0] [get_bd_pins PS_0/emio_uart1_txd]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins PS_0/maxihpm0_fpd_aclk] [get_bd_pins PS_0/maxihpm1_fpd_aclk] [get_bd_pins PS_0/pl_clk0] [get_bd_pins PS_0_axi_periph/S00_ACLK] [get_bd_pins adc_sink_i/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins dac_source_i/s_axi_aclk] [get_bd_pins rst_PS_0_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0_i/s_axi_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins PS_0/pl_resetn0] [get_bd_pins rst_PS_0_99M/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0xB0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs adc_sink_i/s_axi/reg0] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs axi_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0xA00C2000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0xB0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs dac_source_i/s_axi/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs data_source/s_axi_CNTRL/Reg] -force
  assign_bd_address -offset 0xA00D0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs dec_ip_mon/s_axi_CNTRL/Reg] -force
  assign_bd_address -offset 0xA00E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs dec_op_mon/s_axi_CNTRL/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs enc_ip_mon/s_axi_CNTRL/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs enc_op_mon/s_axi_CNTRL/Reg] -force
  assign_bd_address -offset 0xA00C1000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs gpio_reset/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs sd_fec_dec/S_AXI/PARAMS] -force
  assign_bd_address -offset 0xA0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs sd_fec_enc/S_AXI/PARAMS] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs stats/s_axi_CNTRL/Reg] -force
  assign_bd_address -offset 0xB0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces PS_0/Data] [get_bd_addr_segs usp_rf_data_converter_0_i/s_axi/Reg] -force

...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module demod_func1_demodbkb_rom (
...
initial begin
    $readmemh("./demod_func1_demodbkb_rom.dat", ram0);
    $readmemh("./demod_func1_demodbkb_rom.dat", ram1);
    $readmemh("./demod_func1_demodbkb_rom.dat", ram2);
end
...
demod_func1_demodbkb_rom demod_func1_demodbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

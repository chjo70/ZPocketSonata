...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module awgn_real1_gradiehbi_rom (
...
initial begin
    $readmemh("./awgn_real1_gradiehbi_rom.dat", ram0);
    $readmemh("./awgn_real1_gradiehbi_rom.dat", ram1);
end
...
awgn_real1_gradiehbi_rom awgn_real1_gradiehbi_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

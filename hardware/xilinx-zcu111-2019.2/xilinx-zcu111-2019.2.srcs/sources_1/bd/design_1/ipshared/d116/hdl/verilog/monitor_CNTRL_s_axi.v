...
#(parameter
    ...
    input  wire [31:0]                   first_V,
    input  wire [31:0]                   last_V,
    input  wire [31:0]                   stalled_V
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_IER                 = 6'h08,
    ADDR_ISR                 = 6'h0c,
    ADDR_NUM_BLOCKS_V_DATA_0 = 6'h10,
    ADDR_NUM_BLOCKS_V_CTRL   = 6'h14,
    ADDR_FIRST_V_DATA_0      = 6'h18,
    ADDR_FIRST_V_CTRL        = 6'h1c,
    ADDR_LAST_V_DATA_0       = 6'h20,
    ADDR_LAST_V_CTRL         = 6'h24,
    ADDR_STALLED_V_DATA_0    = 6'h28,
    ADDR_STALLED_V_CTRL      = 6'h2c,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_first_V = 'b0;
    reg  [31:0]                   int_last_V = 'b0;
    reg  [31:0]                   int_stalled_V = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FIRST_V_DATA_0: begin
                    rdata <= int_first_V[31:0];
                end
                ADDR_LAST_V_DATA_0: begin
                    rdata <= int_last_V[31:0];
                end
                ADDR_STALLED_V_DATA_0: begin
                    rdata <= int_stalled_V[31:0];
                end
            endcase
        end
    end

DECLARE
    nCnt NUMBER;
BEGIN
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_COMMENTS';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_COMMENTS';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_COMMENTS_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_COMMENTS_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'WEAPON_SYSTEM';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.WEAPON_SYSTEM';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'WEAPON_SYSTEM_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.WEAPON_SYSTEM_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'ASSOC_WEAP_SYS';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.ASSOC_WEAP_SYS';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'ASSOC_WEAP_SYS_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.ASSOC_WEAP_SYS_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'PLATFORM';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.PLATFORM';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'PLATFORM_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.PLATFORM_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'ASSOC_PLATFORM';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.ASSOC_PLATFORM';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'ASSOC_PLATFORM_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.ASSOC_PLATFORM_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'ASSOC_ELNOT';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.ASSOC_ELNOT';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'ASSOC_ELNOT_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.ASSOC_ELNOT_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'PARAM_SET_ASSOCIATIONS';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.PARAM_SET_ASSOCIATIONS';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'PARAM_SET_ASSOCIATIONS_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.PARAM_SET_ASSOCIATIONS_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_COMMENTS';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_COMMENTS';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_COMMENTS_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_COMMENTS_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_LIFECYCLE';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_LIFECYCLE';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_LIFECYCLE_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_LIFECYCLE_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_SEQUENCE_NAME';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_SEQUENCE_NAME';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_SEQUENCE_NAME_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_SEQUENCE_NAME_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_SEQUENCE';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_SEQUENCE';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_SEQUENCE_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_SEQUENCE_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_SPOT_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_SPOT_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PD_SPOT_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PD_SPOT_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_SEQUENCE_NAME';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_SEQUENCE_NAME';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_SEQUENCE_NAME_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_SEQUENCE_NAME_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_SEQUENCE';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_SEQUENCE';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_SEQUENCE_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_SEQUENCE_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_SPOT_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_SPOT_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_RF_SPOT_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_RF_SPOT_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_SEQUENCE_NAME';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_SEQUENCE_NAME';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_SEQUENCE_NAME_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_SEQUENCE_NAME_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_SEQUENCE';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_SEQUENCE';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_SEQUENCE_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_SEQUENCE_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_SPOT_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_SPOT_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_SPOT_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_SPOT_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_GROUP_SPACING';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_GROUP_SPACING';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_PRI_GROUP_SPACING_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_PRI_GROUP_SPACING_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_VALUES';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_VALUES';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_VALUES_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_VALUES_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_SEQ_NAME';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_SEQ_NAME';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_SEQ_NAME_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_SEQ_NAME_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_SEQUENCE';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_SEQUENCE';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MOP_CW_SEQUENCE_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MOP_CW_SEQUENCE_P';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_PA_DIFF_IN_GROUP';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_PA_DIFF_IN_GROUP';
    end if;
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'RADAR_MODE_PA_DIFF_IN_GROUP_P';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.RADAR_MODE_PA_DIFF_IN_GROUP_P';
    end if;
END;

CREATE TABLE EW701.RADAR
(
  RADAR_INDEX                 INTEGER           DEFAULT -1       				NOT NULL,
  SECLAB                      INTEGER           DEFAULT -1							NOT NULL,
  ELNOT                       VARCHAR2(5 BYTE) 	UNIQUE  								NOT NULL,
  NICKNAME                    VARCHAR2(30 BYTE),
  FUNCTION_CODE               VARCHAR2(2 BYTE),
...
CREATE TABLE EW701.RADAR_COMMENTS
(
...
CREATE TABLE EW701.RADAR_COMMENTS_P
(
  RADAR_COMMENT_INDEX     INTEGER               NOT NULL,
  RADAR_INDEX             INTEGER               NOT NULL,
  TITLE                   VARCHAR2(30 BYTE)     NOT NULL,
...
CREATE TABLE EW701.WEAPON_SYSTEM
(
  WEAPON_SYS            VARCHAR2(40 BYTE)       NOT NULL,
...
CREATE TABLE EW701.WEAPON_SYSTEM_P
(
  WEAPON_SYS            VARCHAR2(40 BYTE)       NOT NULL,
  WEAPON_INDEX          INTEGER                 NOT NULL,
  SECLAB                INTEGER                 NOT NULL,
...
CREATE TABLE EW701.ASSOC_WEAP_SYS
(
  RADAR_INDEX   INTEGER                         NOT NULL,
  WEAPON_INDEX  INTEGER                         NOT NULL,
  SECLAB        INTEGER                         NOT NULL,
...
CREATE TABLE EW701.ASSOC_WEAP_SYS_P
(
  RADAR_INDEX   INTEGER                         NOT NULL,
  WEAPON_INDEX  INTEGER                         NOT NULL,
  SECLAB        INTEGER                         NOT NULL,
...
CREATE TABLE EW701.PLATFORM
(
  PLATFORM_INDEX        INTEGER                 NOT NULL,
  PLATFORM              VARCHAR2(40 BYTE)       NOT NULL,
  SECURITY_REVIEW_DATE  TIMESTAMP(6),
  DATE_LAST_UPDATED     TIMESTAMP(6),
  SECLAB                INTEGER                 NOT NULL,
  PRIMARY KEY (PLATFORM_INDEX)
);
CREATE TABLE EW701.PLATFORM_P
(
  PLATFORM_INDEX        INTEGER                 NOT NULL,
  PLATFORM              VARCHAR2(40 BYTE)       NOT NULL,
  SECURITY_REVIEW_DATE  TIMESTAMP(6),
...
CREATE TABLE EW701.ASSOC_PLATFORM
(
  RADAR_INDEX     INTEGER                       NOT NULL,
  PLATFORM_INDEX  INTEGER                       NOT NULL,
  SECLAB          INTEGER                       NOT NULL,
...
CREATE TABLE EW701.ASSOC_PLATFORM_P
(
  RADAR_INDEX     INTEGER                       NOT NULL,
  PLATFORM_INDEX  INTEGER                       NOT NULL,
  SECLAB          INTEGER                       NOT NULL,
...
CREATE TABLE EW701.ASSOC_ELNOT
(
  RADAR_INDEX        INTEGER                    NOT NULL,
...
CREATE TABLE EW701.ASSOC_ELNOT_P
(
  RADAR_INDEX        INTEGER                    NOT NULL,
  ASSOC_RADAR_INDEX  INTEGER                    NOT NULL,
  SECLAB             INTEGER                    NOT NULL,
...
CREATE TABLE EW701.PARAM_SET_ASSOCIATIONS
(
  ASSOC_INDEX  INTEGER                          NOT NULL,
  RADAR_INDEX  INTEGER                          NOT NULL,
  SET_CODE     VARCHAR2(2 BYTE)                 NOT NULL,
  ASSOC_TYPE   INTEGER                          NOT NULL,
  SECLAB       INTEGER                          DEFAULT NULL                  NOT NULL,
  PRIMARY KEY (ASSOC_INDEX)
);
CREATE TABLE EW701.PARAM_SET_ASSOCIATIONS_P
(
  ASSOC_INDEX  INTEGER                          NOT NULL,
  RADAR_INDEX  INTEGER                          NOT NULL,
  SET_CODE     VARCHAR2(2 BYTE)                 NOT NULL,
...
(
  ...
  LAST_UPDATED_BY                 INTEGER                        DEFAULT -1,
  SIGNAL_TYPE                     VARCHAR2(10 BYTE) NOT NULL,
  ...
  ERP_PATTERN_DRIVER              VARCHAR2(400 BYTE)             DEFAULT 'X',
  ERP_PATTERN_RULE                VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  POL_TILT_ANGLE_PATTERN_DRIVER   VARCHAR2(400 BYTE)             DEFAULT 'X',
  POL_TILT_ANGLE_PATTERN_RULE     VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  RF_PATTERN_DRIVER               VARCHAR2(400 BYTE)             DEFAULT 'X',
  RF_PATTERN_RULE                 VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  PRI_PATTERN_DRIVER              VARCHAR2(400 BYTE)             DEFAULT 'X',
  PRI_PATTERN_RULE                VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  PD_PATTERN_DRIVER               VARCHAR2(400 BYTE)             DEFAULT 'X',
  PD_PATTERN_RULE                 VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  SCAN_PRIMARY_PATTERN_DRIVER     VARCHAR2(400 BYTE)             DEFAULT 'X',
  SCAN_PRIMARY_PATTERN_RULE       VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  SCAN_SECONDARY_PATTERN_DRIVER   VARCHAR2(400 BYTE)             DEFAULT 'X',
  SCAN_SECONDARY_PATTERN_RULE     VARCHAR2(400 BYTE)             DEFAULT 'X',
  ...
  COMMS_MULTIP_SCHEME             VARCHAR2(20 BYTE)              DEFAULT 'X',
  COMMS_MULTIP_TYPE               VARCHAR2(20 BYTE)              DEFAULT 'X',
  COMMS_MULTIP_LEVEL              VARCHAR2(20 BYTE)              DEFAULT 'X',
  COMMS_SUBCARRIER_MODULATION     VARCHAR2(20 BYTE)              DEFAULT 'X',
  ...
  PARAM_ASSOC                     VARCHAR2(390 BYTE)             DEFAULT 'X',
  ...
  MODULATION_CODE                 VARCHAR2(2 BYTE)               DEFAULT 'ZZ',
  PRIORITY                        INTEGER                        DEFAULT -1,  
  RF_TYPE                         INTEGER,  
  PRI_TYPE                        INTEGER,  
  PRIMARY KEY (RADAR_MODE_INDEX)
);
CREATE TABLE EW701.RADAR_MODE_P
(
  RADAR_MODE_INDEX                INTEGER       NOT NULL,
  SECLAB                          INTEGER       NOT NULL,
  FUNCTION_CODE                   VARCHAR2(2 BYTE),
  ...
  ERP_PATTERN                     INTEGER,
  ERP_PATTERN_DRIVER              VARCHAR2(400 BYTE),
  ERP_PATTERN_RULE                VARCHAR2(400 BYTE),
  ...
  POL_TILT_ANGLE_PATTERN_DRIVER   VARCHAR2(400 BYTE),
  POL_TILT_ANGLE_PATTERN_RULE     VARCHAR2(400 BYTE),
  ...
  RF_PATTERN_DRIVER               VARCHAR2(400 BYTE),
  RF_PATTERN_RULE                 VARCHAR2(400 BYTE),
  ...
  PRI_PATTERN                     INTEGER                           DEFAULT -1,
  PRI_PATTERN_DRIVER              VARCHAR2(400 BYTE),
  PRI_PATTERN_RULE                VARCHAR2(400 BYTE),
  ...
  PD_PATTERN_DRIVER               VARCHAR2(400 BYTE),
  PD_PATTERN_RULE                 VARCHAR2(400 BYTE),
  ...
  SCAN_PRIMARY_PATTERN_DRIVER     VARCHAR2(400 BYTE),
  SCAN_PRIMARY_PATTERN_RULE       VARCHAR2(400 BYTE),
  ...
  SCAN_SECONDARY_PATTERN_DRIVER   VARCHAR2(400 BYTE),
  SCAN_SECONDARY_PATTERN_RULE     VARCHAR2(400 BYTE),
  ...
  COMMS_MULTIP_SCHEME             VARCHAR2(20 BYTE),
  COMMS_MULTIP_TYPE               VARCHAR2(20 BYTE),
  COMMS_MULTIP_LEVEL              VARCHAR2(20 BYTE),
  COMMS_SUBCARRIER_MODULATION     VARCHAR2(20 BYTE),
  ...
  SECURITY_REVIEW_DATE            TIMESTAMP(6),
  ASSOC_INDEX                     INTEGER,
  MODULATION_CODE                 VARCHAR2(2 BYTE),
  PRIORITY                        INTEGER,
  RF_TYPE                         INTEGER,  
  PRI_TYPE                        INTEGER,  
  PRIMARY KEY (RADAR_MODE_INDEX)
);
CREATE TABLE EW701.RADAR_MODE_COMMENTS
(
...
CREATE TABLE EW701.RADAR_MODE_COMMENTS_P
(
  RADAR_MODE_COMMENT_INDEX    INTEGER               NOT NULL,
  RADAR_MODE_INDEX            INTEGER               NOT NULL,
  TITLE                       VARCHAR2(30 BYTE)     NOT NULL,
...
CREATE TABLE EW701.RADAR_MODE_LIFECYCLE
(
  RADAR_INDEX       INTEGER                     NOT NULL,
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RADAR_MODE_NAME   VARCHAR2(30 BYTE)           NOT NULL,
  MODE_CODE         VARCHAR2(5 BYTE)            NOT NULL,
  SECLAB            INTEGER                     DEFAULT NULL                  NOT NULL,
  PRIMARY KEY (RADAR_INDEX, RADAR_MODE_INDEX)
);
CREATE TABLE EW701.RADAR_MODE_LIFECYCLE_P
(
  RADAR_INDEX       INTEGER                     NOT NULL,
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RADAR_MODE_NAME   VARCHAR2(30 BYTE)           NOT NULL,
...
CREATE TABLE EW701.RADAR_PD_VALUES
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PD_VALUES_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PD_INDEX          INTEGER                     NOT NULL,
  SECLAB            INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PD_SEQUENCE_NAME
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PD_SEQ_ID         INTEGER                     NOT NULL,
  PD_SEQ_NAME       VARCHAR2(32 BYTE),
  SECLAB            INTEGER                     NOT NULL,
  PRIMARY KEY (RADAR_MODE_INDEX, PD_SEQ_ID)
);
CREATE TABLE EW701.RADAR_PD_SEQUENCE_NAME_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PD_SEQ_ID         INTEGER                     NOT NULL,
  PD_SEQ_NAME       VARCHAR2(32 BYTE),
...
CREATE TABLE EW701.RADAR_PD_SEQUENCE
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PD_SEQUENCE_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PD_SEQUENCE_NUM   INTEGER                     NOT NULL,
  SECLAB            INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PD_SPOT_VALUES
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PD_MIN            FLOAT(52)                   NOT NULL,
  PD_MAX            FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_PD_SPOT_VALUES_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PD_MIN            FLOAT(52)                   NOT NULL,
  PD_MAX            FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_RF_VALUES
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_RF_VALUES_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RF_INDEX          INTEGER                     NOT NULL,
  SECLAB            INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_RF_SEQUENCE_NAME
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RF_SEQ_ID         INTEGER                     NOT NULL,
  RF_SEQ_NAME       VARCHAR2(32 BYTE),
  SECLAB            INTEGER                     NOT NULL,
  PRIMARY KEY (RADAR_MODE_INDEX, RF_SEQ_ID)
);
CREATE TABLE EW701.RADAR_RF_SEQUENCE_NAME_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RF_SEQ_ID         INTEGER                     NOT NULL,
  RF_SEQ_NAME       VARCHAR2(32 BYTE),
...
CREATE TABLE EW701.RADAR_RF_SEQUENCE
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_RF_SEQUENCE_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RF_SEQUENCE_NUM   INTEGER                     NOT NULL,
  SECLAB            INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_RF_SPOT_VALUES
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RF_MIN            FLOAT(52)                   NOT NULL,
  RF_MAX            FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_RF_SPOT_VALUES_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  RF_MIN            FLOAT(52)                   NOT NULL,
  RF_MAX            FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_VALUES
(
  RADAR_MODE_INDEX    INTEGER                   NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_VALUES_P
(
  RADAR_MODE_INDEX    INTEGER                   NOT NULL,
  PRI_INDEX           INTEGER                   NOT NULL,
  SECLAB              INTEGER                   NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_SEQUENCE_NAME
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PRI_SEQ_ID        INTEGER                     NOT NULL,
  PRI_SEQ_NAME      VARCHAR2(32 BYTE),
  SECLAB            INTEGER                     NOT NULL,
  PRIMARY KEY (RADAR_MODE_INDEX, PRI_SEQ_ID)
);
CREATE TABLE EW701.RADAR_PRI_SEQUENCE_NAME_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PRI_SEQ_ID        INTEGER                     NOT NULL,
  PRI_SEQ_NAME      VARCHAR2(32 BYTE),
...
CREATE TABLE EW701.RADAR_PRI_SEQUENCE
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_SEQUENCE_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PRI_SEQUENCE_NUM  INTEGER                     NOT NULL,
  SECLAB            INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_SPOT_VALUES
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PRI_MIN           FLOAT(52)                   NOT NULL,
  PRI_MAX           FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_SPOT_VALUES_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  PRI_MIN           FLOAT(52)                   NOT NULL,
  PRI_MAX           FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_GROUP_SPACING
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_PRI_GROUP_SPACING_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  SEQUENCE_NUM      INTEGER                     NOT NULL,
  GROUP_SPACING     FLOAT(52)                   NOT NULL,
...
CREATE TABLE EW701.RADAR_MOP_CW
(
  RADAR_MODE_INDEX               INTEGER        NOT NULL,
  ...
  MOP_CW_PATTERN_DRIVER          VARCHAR2(400 BYTE),
  MOP_CW_PATTERN_PERIOD_MIN      FLOAT(52),
  MOP_CW_PATTERN_PERIOD_MAX      FLOAT(52),
  MOP_CW_PATTERN_RULE            VARCHAR2(400 BYTE),
  ...
  MOP_CW_PATTERN_NAME            VARCHAR2(20 BYTE),
...
CREATE TABLE EW701.RADAR_MOP_CW_P
(
  RADAR_MODE_INDEX               INTEGER        NOT NULL,
  MOP_CW_INDEX                   INTEGER        NOT NULL,
  SECLAB                         INTEGER        NOT NULL,
...
CREATE TABLE EW701.RADAR_MOP_CW_VALUES
(
  RADAR_MODE_INDEX    INTEGER                   NOT NULL,
  MOP_CW_INDEX        INTEGER                   NOT NULL,
...
CREATE TABLE EW701.RADAR_MOP_CW_VALUES_P
(
  RADAR_MODE_INDEX    INTEGER                   NOT NULL,
  MOP_CW_INDEX        INTEGER                   NOT NULL,
  MOP_CW_VALUE_INDEX  INTEGER                   NOT NULL,
...
CREATE TABLE EW701.RADAR_MOP_CW_SEQ_NAME
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  MOP_CW_INDEX      INTEGER                     NOT NULL,
  MOP_CW_SEQ_ID     INTEGER                     NOT NULL,
  MOP_CW_SEQ_NAME   VARCHAR2(32 BYTE),
  SECLAB            INTEGER                     NOT NULL,
  PRIMARY KEY (RADAR_MODE_INDEX, MOP_CW_INDEX, MOP_CW_SEQ_ID)
);
CREATE TABLE EW701.RADAR_MOP_CW_SEQ_NAME_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  MOP_CW_INDEX      INTEGER                     NOT NULL,
  MOP_CW_SEQ_ID     INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_MOP_CW_SEQUENCE
(
  RADAR_MODE_INDEX     INTEGER                  NOT NULL,
  MOP_CW_INDEX         INTEGER                  NOT NULL,
...
CREATE TABLE EW701.RADAR_MOP_CW_SEQUENCE_P
(
  RADAR_MODE_INDEX     INTEGER                  NOT NULL,
  MOP_CW_INDEX         INTEGER                  NOT NULL,
  MOP_CW_SEQUENCE_NUM  INTEGER                  NOT NULL,
...
CREATE TABLE EW701.RADAR_MODE_PA_DIFF_IN_GROUP
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  SEQUENCE_NUM      INTEGER                     NOT NULL,
...
CREATE TABLE EW701.RADAR_MODE_PA_DIFF_IN_GROUP_P
(
  RADAR_MODE_INDEX  INTEGER                     NOT NULL,
  SEQUENCE_NUM      INTEGER                     NOT NULL,
  PA_DIFF           FLOAT(52)                   NOT NULL,

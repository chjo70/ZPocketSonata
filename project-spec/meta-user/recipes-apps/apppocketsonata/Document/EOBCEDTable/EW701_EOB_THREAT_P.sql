ALTER TABLE EW701.THREAT_P
 DROP PRIMARY KEY CASCADE;

DROP TABLE EW701.THREAT_P CASCADE CONSTRAINTS;
...
--  There is no statement for index EW701.SYS_C0054469.
--  The object is created when the parent object is created.

--  There is no statement for index EW701.SYS_C0054470.
--  The object is created when the parent object is created.

ALTER TABLE EW701.THREAT_P ADD (
  PRIMARY KEY
  (THREAT_INDEX)
  USING INDEX
    TABLESPACE EW701

...
BEGIN
    ...
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'E_AA_MSG_LOB_LINK2';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.E_AA_MSG_LOB_LINK2';
    end if;
...
CREATE TABLE EW701.E_AA_MSG_LOB_LINK2
(

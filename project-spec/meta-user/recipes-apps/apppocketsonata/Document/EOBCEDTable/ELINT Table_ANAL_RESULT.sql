...
BEGIN
    ...
    SELECT COUNT(*) INTO nCnt FROM ALL_TABLES WHERE TABLE_NAME = 'E_ANAL_RESULT';
    if nCnt > 0 then execute immediate 'DROP TABLE EW701.E_ANAL_RESULT';
    end if;
...
COMMENT ON COLUMN EW701.E_ANAL_RESULT.AET_ID IS 'AET번호';

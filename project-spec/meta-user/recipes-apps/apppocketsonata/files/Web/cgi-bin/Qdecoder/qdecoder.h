 ...
 * qHttpHeader.c
 */
void      qContentType(const char *mimetype);
...
char      *qStristr(char *big, char *small_);
 ...
 * qCount.c
 */
long       qCountRead(char *filename);
int       qCountSave(char *filename, long number);
int       qCountUpdate(char *filename, long number);
...
extern char upload_savedir[1024];

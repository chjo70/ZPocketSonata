...
function qUpload(qForm) {
  ...
  // firefox 
    ...
    window.open(q_upload_action+"?Q_UPLOAD_ID="+q_upload_id+"&Q_UPLOAD_DRAWRATE="+Q_UPLOAD_DRAWRATE+"&Q_UPLOAD_TEMPLATE="+Q_UPLOAD_TEMPLATE, null, "width=380,height=110,status=yes,toolbar=yes,menubar=no,location=no,resizable=no,scrollbars=no,copyhistory=no");
  }

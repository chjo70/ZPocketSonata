...
#if (defined (SCOV5) || defined (__VXWORKS__) || defined (LINUX) || defined (LYNX) || defined (MACOSX))
#ifndef O_BINARY
#define O_BINARY 		0
#endif /* O_BINARY */
#define	SOCKET_ERROR	-1
#endif /* SCOV5 || __VXWORKS__ || LINUX || LYNX || MACOSX */
...
#define gchdir		_wmkdir
#define gmkdir		_wchdir
#define grmdir		_wrmdir
#define ggetcwd		getcwduser
#endif
...
#else
#define SOCKET_BUFSIZ			(10*1024)	/* Underlying buffer size */
#endif /* LITTLEFOOT */
...
extern char_t *getcwduser( char_t *buffer, int size );

...
/**
 * @brief GPIO::OpenChannel
 * @param gpio_base
 * @return
 */
int CGPIO::OpenChannel( int gpio_base )
{
    ...
    char gpio_export_file[30] = "/sys/class/gpio/export";
	int export_fd=0;
...
/**
 * @brief CGPIO::CloseChannel
 * @param gpio_base
 * @return
 */
int CGPIO::CloseChannel( int gpio_base )
{
	char gpio_nchan_file[128];
	int gpio_nchan_fd;
	int gpio_max;
    ...
    char gpio_unexport_file[50] = "/sys/class/gpio/unexport";
	int unexport_fd=0;
...
/**
 * @brief CGPIO::SetDirection
 * @param gpio_base
 * @param nchannel
 * @param direction
 * @return
 */
int CGPIO::SetDirection(int gpio_base, int nchannel, char *direction)
{
...
/**
 * @brief CGPIO::SetValue
 * @param gpio_base
 * @param nchannel
 * @param value
 * @return
 */
int CGPIO::SetValue(int gpio_base, int nchannel, int value)
{
...
/**
 * @brief CGPIO::GetValue
 * @param gpio_base
 * @param nchannel
 * @return
 */
int CGPIO::GetValue(int gpio_base, int nchannel)
{
	char gpio_val_file[128];
	int val_fd=0;
	int gpio_max;

...
//#include "../ALGORITHM/MergeSignal/Stack.h"
//#include "../ALGORITHM/InterSignal/SysPara.h"
...
// 	
 	SELAETDATA *m_pMergeAETData;							///< 변경할 빔 위협에 대한 AET 데이터 포인터
 	SELAETDATA_EXT *m_pMergeAETExtData;				///< 변경할 빔 위협에 대한 AET 확장 데이터 포인터
 	SELAETDATA *m_pDeleteAETData;							///< 삭제할 빔 위협에 대한 AET 데이터 포인터
...
// 
 	CELEmitterMergeMngr( bool bSimulator );
 	bool ManageThreat( SRxLOBHeader* pLOBHeader, SRxLOBData* pLOBData, bool i_bIsFilteredLOB, bool i_bCheckLOBMerge=false );
...
// 	// 	
 	...
 	inline SELAETDATA *GetAETData( int nIndex ) { return & ( (m_pUniThreat + nIndex)->uniAET.stAETData); }
...
// 	// 빔 병합
 	...
 	bool IsSelectAET( SELAETDATA *pAETData, SELAETDATA *pMatchAETData );
...
// 	// 업데이트 처리 관련 함수 (AET)
 	...
 	void UpdateFreqInfo( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, SRxABTData *pABTData, SELABTDATA_EXT *pABTExtData );
 	void UpdatePRIInfo( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, SRxABTData *pABTData, SELABTDATA_EXT *pABTExtData );
 	void UpdatePWInfo( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, SRxABTData *pABTData, SELABTDATA_EXT *pABTExtData );
 	void UpdatePAInfo( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, SRxABTData *pABTData, SELABTDATA_EXT *pABTExtData );
 	void UpdatePEInfo( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, CELThreat *pTheAETThreat, SRxABTData *pManABTData=NULL );
	void UpdateIDInfo( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, CELThreat *pTheAETThreat );
 	void UpdateSeenTime( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, SRxABTData *pABTData, SELABTDATA_EXT *pABTExtData );
 	void UpdateSeenTime( SELAETDATA *pUpdateAETData, SELAETDATA_EXT *pUpdateAETExtData, SELAETDATA *pDeleteAETData, SELAETDATA_EXT *pDeleteAETExtData );
...
// 	// 빔 유효성 업데이트시 관련 함수
 	...
 	void UpdateBeamValidity( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData, CELThreat *pTheAETThreat );
...
// 	void UpdateAlertTimeToEmitterDB( SRxABTData *pAETData, SELABTDATA_EXT *pAETExtData );
 	void UpdateEmitterStatusToEmitterDB( SELAETDATA *pAETData, SELAETDATA_EXT *pAETExtData );

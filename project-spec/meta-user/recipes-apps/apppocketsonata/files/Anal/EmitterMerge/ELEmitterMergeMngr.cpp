 ...
 * @warning
 */
bool CELEmitterMergeMngr::ManageThreat( SRxLOBHeader* pLOBHeader, SRxLOBData* pLOBData, SLOBOtherInfo *pLOBOtherInfo, bool bIsFilteredLOB, bool bCheckLOB )
{
    bool bMerge;
...
void CELEmitterMergeMngr::InsertLOB( SELLOBDATA_EXT *pExt, bool i_bIsFilteredLOB )
{
    ...
    if( m_pLOBOtherInfo->bUpdate == false ) {
        ...
        //strcpy_s( m_pLOBData->szszModulationCode, m_pLOBOtherInfo->szModulationCode );
        //strcpy_s( m_pLOBData.szNickName, m_pLOBOtherInfo->szNickName );

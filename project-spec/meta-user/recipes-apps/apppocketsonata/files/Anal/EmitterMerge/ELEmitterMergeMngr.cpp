...
CELEmitterMergeMngr::CELEmitterMergeMngr(bool bDBThread, const char *pFileName ) : Database( pFileName )
{
	bool bRtn = false;
...
{
#ifdef _SQLITE_
    m_pIdentifyAlg = new CELSignalIdentifyAlg( CEDEOB_SQLITE_FILENAME );
#else

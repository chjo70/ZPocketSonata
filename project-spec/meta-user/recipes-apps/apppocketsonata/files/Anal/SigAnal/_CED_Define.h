...
#define _MAX_RADARMODE_NAME_SIZE									(30)
#define _MAX_RADARNAME_SIZE											(_MAX_RADARMODE_NAME_SIZE)
...
#define _MAX_ELNOT_STRING_SIZE_										(5+_NULL_CHAR_)
...
#define _MAX_SIZE_OF_KOREASITENAME_									(29+_NULL_CHAR_)

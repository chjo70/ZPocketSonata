...
public:
	...
	int ExtractStagger(STR_PDWINDEX *pPdwIndex, UINT framePri, STR_EMITTER *pEmitter );
	...
	void ExtractDwellRefPT( STR_PRI_RANGE_TABLE *pExtRange );
	...
	int VerifyPRI( PDWINDEX *pPdwIndex, int count );

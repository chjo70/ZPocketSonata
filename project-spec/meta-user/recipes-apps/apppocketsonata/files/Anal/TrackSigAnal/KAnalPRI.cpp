...
//
int CKAnalPRI::ExtractStagger(STR_PDWINDEX *pPdwIndex, UINT framePri, STR_EMITTER *pEmitter )
{
...
//
void CKAnalPRI::ExtractDwellRefPT( STR_PRI_RANGE_TABLE *pExtRange ) 
{ 
	m_pKnownSigAnal->ExtractDwellRefPT( pExtRange ); 
}
...
//
UINT CKAnalPRI::ExtractFramePri(STR_PDWINDEX *pSrcPdwIndex, UINT framePri ) 
{	
...
//T
int CKAnalPRI::VerifyPRI( PDWINDEX *pPdwIndex, int count )
{

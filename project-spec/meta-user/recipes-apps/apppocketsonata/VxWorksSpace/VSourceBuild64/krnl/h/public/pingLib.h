...
/*
 * Copyright (c) 1994-2006, 2016  Wind River Systems, Inc.
 *
...
26oct06,tkf  Restore removed structures (needed by pingLib.c for user side
             build).
20sep06,tlu  Restore some header file, constant and type definitions
03aug06,kch  Cleanup for IPNet stack. Changed PING_TMO from 5 to 1 sec.
07feb05,vvv  _KERNEL cleanup
20nov03,niq  Remove copyright_wrs.h file inclusion
14nov03,asr  Changes for porting ping to RTP
...
15may03,spm  Tornado 2.2 FCS merge (SPR #73570; ver 01d,12mar02,rae:
             TOR2_2-FCS-COPY label, tor2 branch, /wind/river VOB)
09may03,vvv  included ip_icmp.h
25jul02,ant  definitions ICMP_PROTO and ICMP_TYPENUM removed 
03may02,ant  u_char	bufTx [PING_MAXPACKET] in the struct PING_STAT changed
...
14jan00,ham  changed PING_STAT for PD support.
25oct94,dzb  written.
*/
...
typedef TASK_ID (*Vxcoreip_shellTaskGet_ptr)(void *shellId);
typedef void*   (*Vxcoreip_shellFromTaskGet_ptr)(TASK_ID taskId);

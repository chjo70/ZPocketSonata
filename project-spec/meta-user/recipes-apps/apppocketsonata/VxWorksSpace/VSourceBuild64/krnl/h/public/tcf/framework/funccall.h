...
struct FunctionCallInfo {
    ...
    Symbol * func;              /* Function declaration */
    Symbol ** args;             /* Argument types given in the call */
    unsigned args_cnt;          /* Number of arguments */

    /* Outputs */
    LocationExpressionCommand ** cmds; /* list of location expressions */
    unsigned * cmds_cnt;        /* Number of location expressions */

    RegisterDefinition ** saveregs; /* List of register to save before calling the function */
    unsigned * saveregs_cnt;    /* Number of register to save */
 ...
 *
 * When calling the function, the client will save the enumerated by
...
extern int get_function_call_location_expression(struct FunctionCallInfo * info);

...
#define NTP_MINDPOLL	5	/* log2 default min poll (32 s). Using a smaller poll as default in vxworks 
                               will make NTP synchronize to server more quickly. */
...
#define LOGTOD(a)	((a) < 0 ? 1. / (1L << -(a)) : 1L << (int)(a)) /* log2 to double */

...
extern int	zbufSockBufSend64 (int s, char *buf, int bufLen,
                    VOIDFUNCPTR freeRtn, void *freeArg, int flags);
extern int	zbufSockBufSendto (int s, char *buf, int bufLen,
                    VOIDFUNCPTR freeRtn, int freeArg, int flags,
                    struct sockaddr *to, int tolen);
extern int	zbufSockBufSendto64 (int s, char *buf, int bufLen,
                    VOIDFUNCPTR freeRtn, void *freeArg, int flags,
                    struct sockaddr *to, int tolen);

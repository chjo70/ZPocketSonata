...
--------------------
01apr15,rjq  Change unreadable characters for doc.  (V7NET-537)
*/
 ...
 */
IP_STATIC int
ipftpc_socketwrite_ascii(Ipftpc_session *session,Ip_fd fd, char *buf, char *nbuf, int bufsize);
 ...
 *      flag       packet flag.
 * Returns:
 *      1 if success, 0 if fail, 2 if don't use tls.
 */
IP_STATIC int 
ipftpc_tls_send(Ipftpc_id id,char *buf, int len,int flag);
 ...
 *      buf        Data buffer.
 *      buflen   Data length.
 *      len        len of packet that is actually sent.
 *      flag       packet flag.
 * Returns:
 *      0 if success, 1 if don't use tls. 
 */
IP_STATIC int 
ipftpc_tls_read(Ipftpc_id id, char *buf, int buflen, int *len, int flag);

/*
 *===========================================================================
 *      ipftpc_tls_free_data_connect
 *===========================================================================
 * Description:
 *      free a tls connection for ftp data connection 
 *
 * Parameters:
 *      id      The session ID.
 * Returns:
 ...
 */
IP_STATIC int 
ipftpc_tls_free_data_connect(Ipftpc_id id);
 ...
 */
IP_GLOBAL int 
ipftpc_ccc(Ipftpc_id id);

/*
 *===========================================================================
 *      ipftpc_tls_free_control_connect
 *===========================================================================
 * Description:
 *      Free a tls control connect
 *
 * Parameters:
 *      id      The session ID.
 * Returns:
 ...
 */
IP_GLOBAL int 
ipftpc_tls_free_control_connect(Ipftpc_id id);

/*
 *===========================================================================
 *      ipftpc_tls_create_control_connect
 *===========================================================================
 * Description:
 *      Create a tls control connect
 *
 * Parameters:
 *      id      The session ID.
 * Returns:
 *      IPCOM_SUCCESS if success, IPCOM_ERR_FAILED if fail.
 */
IP_GLOBAL int 
ipftpc_tls_create_control_connect(Ipftpc_id id);
 ...
 *
 * Parameters:
 *      param      tls descriptor.
 * Returns:
 *      NULL
 */
IP_GLOBAL void 
ipftpc_tls_free_ctx(void *param);
 ...
 *
 * Parameters:
 *      certfile      cert file directory.
 *	  keyfile      key file  directory.
 * Returns:
 *      NULL
 */
IP_GLOBAL void * 
ipftpc_tls_init(char * certfile, char *keyfile);

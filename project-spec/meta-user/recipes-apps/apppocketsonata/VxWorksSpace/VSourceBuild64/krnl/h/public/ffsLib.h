...
/*
 * Copyright (c) 2006-2007, 2009-2010, 2015 Wind River Systems, Inc.
 *
...
#define ffsLsb_autosize(i) ((sizeof(i) == 8) ? ffs64Lsb(i) : ffs32Lsb((UINT32)i))
#define ffsMsb_autosize(i) ((sizeof(i) == 8) ? ffs64Msb(i) : ffs32Msb((UINT32)i))

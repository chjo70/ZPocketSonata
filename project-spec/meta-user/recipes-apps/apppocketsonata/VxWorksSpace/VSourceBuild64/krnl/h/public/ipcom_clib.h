...
#if defined(IPCOM_MEMSET_S) && IPCOM_MEMSET_S != 1
#define ipcom_memset_s IPCOM_MEMSET_S
#elif !defined(IPCOM_MEMSET_S)
#define ipcom_memset_s memset_s
#endif

#if (defined(IPCOM_MEMSET_S) && IPCOM_MEMSET_S == 1) || (defined(IPCOM_USE_CLIB_PROTO) && !defined(IPCOM_CLIB_BUILTIN))
IP_PUBLIC Ip_errno_t ipcom_memset_s(void *dest, Ip_rsize_t destsz, int ch, Ip_rsize_t count);
#endif
...
/* Macro for converting string to integer, ipcom_strtoi */
#ifndef ipcom_strtoi
#define ipcom_strtoi(str, endptr, base) (int)ipcom_strtol(str, endptr, base)
#endif
 ...
 *===========================================================================
 */
IP_PUBLIC void ipcom_shm_free(void *ptr);
 ...
 *===========================================================================
 */
IP_PUBLIC void *ipcom_shm_calloc(Ip_size_t nelem, Ip_size_t elsize);
 ...
 *===========================================================================
 */
IP_PUBLIC void *ipcom_shm_malloc(Ip_size_t size);
 ...
 *===========================================================================
 */
IP_PUBLIC void *ipcom_shm_reserve(Ip_size_t size);
 ...
 *===========================================================================
 */
IP_PUBLIC void * ipcom_shm_component(int facility, Ip_size_t size);

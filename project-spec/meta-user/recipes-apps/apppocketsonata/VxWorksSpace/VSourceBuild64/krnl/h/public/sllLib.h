...
/*
 * Copyright (c) 1989-1992, 2005, 2009-2010, 2012, 2014-2015, 2017 Wind River Systems, Inc.
 *
...
06oct15,clt  Added function prototype for vx7-cert (v7SP-486)
25aug14,clt  vx7-cert clean up
13jun12,jpb  Defect WIND00352633.  Fixed SLL_GET.
04dec10,pad  Replaced FUNCPTR with fully-qualified function pointer in
             sllEach()'s signature.
15jun10,v_r  Fixed SLL_PREVIOUS (def CQ:WIND00196676, merged from
...
19jan05,vvv  moved some macros from osdep.h
...
10aug90,dnw  changed declaration of sllRemove() from STATUS to void.
03jun89,jcf  written.
*/
...
*
* RETURNS: Pointer to the next node in the list, or NULL if no next node.
*
* NOMANUAL
*/
...
extern SL_NODE * sllEach (SL_LIST *pList, BOOL (* routine)
			             (
			             SL_NODE * pNode,
			             _Vx_usr_arg_t arg
			             ),
...
inline SL_NODE * sllEach
    ...
    {
    return sllEach (pList,(BOOL (*)(SL_NODE * pNode, _Vx_usr_arg_t arg))routine,
		            routineArg);
    }

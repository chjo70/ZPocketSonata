...
--------------------
01i,23jan10,y_t Add LP64 support.
...
extern	  bool_t       pmap_set (u_int program, u_int version,
				 u_int protocol, u_int port);
extern	  bool_t       pmap_unset (u_int program, u_int version);
extern    void         pmapUnset(u_int program, u_int version);
extern	  struct       pmaplist *pmap_getmaps (struct sockaddr_in *address);
extern	  u_short      pmap_getport (struct sockaddr_in *address, u_int
				     program, u_int version, u_int protocol);
extern	  enum clnt_stat pmap_rmtcall (struct sockaddr_in *addr, u_int prog,
		       		u_int vers, u_int proc, xdrproc_t xdrargs,
				caddr_t argsp, xdrproc_t xdrres, caddr_t resp,
				struct timeval tout, u_int *port_ptr);
extern    enum clnt_stat clnt_broadcast (u_int prog, u_int vers, u_int proc,

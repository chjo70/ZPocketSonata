...
#define IPCOM_ROUTE_KEY_CMP_MASK_MATCH    -1 /* The keys match if the mask is applied */
#define IPCOM_ROUTE_KEY_CMP_NO_MATCH       0 /* The keys did not match each other */
...
#define IPCOM_ROUTE_FLAG_MASK       0x0FFFFFFFu /* Mask for non-internal flags */
...
typedef struct Ipcom_route_struct
{
    ...
    Ipcom_route_entry   *org_on;   /* The original all bits 1 entry */
    Ipcom_route_entry   *org_off;  /* The original all bits 0 entry */

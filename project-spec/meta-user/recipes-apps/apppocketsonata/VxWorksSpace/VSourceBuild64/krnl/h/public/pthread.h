...
/*
 * Copyright (c) 1984-2004, 2006-2007, 2010-2011, 2013, 2015, 2017
...
--------------------
04may17,dlk  support pthread_condattr_setclock() in the kernel (V7COR-4976)
12jan15,tlu  Add pthread mutex attribute types (US51963)
19jun13,krz  Integrated pthread barriers.
10jan11,pad  Moved internal flags into pthreadLibP.h. Structure
	     pthread_once_t is now declared in base/b_pthread_once_t.h.
11nov10,pad  Moved internal types out into pthreadLibP.h
14apr10,jpb  Updated for LP64 adaptation.
02may07,jpb  SMP audit.  Removed unused structure fields.
30aug06,pad  Removed direct pthread_t type definition and include
             base/b_pthread_t.h instead (defect 63706 / fix 63777).
27mar06,jpb  Fixed a couple of function prototypes for conformance (SPR
...
22feb06,pes  Add base/b_pthread_attr_t.h include
06jan06,gls  moved pthread_attr_t to pthreadCommon.h
27sep04,pad  Added onceDone and onceMyTid fields to the pthread_once_t
             type (SPR #98589).
...
19mar04,pad  Provided macro definitions to make all supported routine
	     ...
	     macro (SPR 96603).
22oct01,jgn  add definition of PTHREAD_STACK_MIN (SPR #71110)
11sep00,jgn  split into kernel & user level parts (SPR #33375)
17jul00,jgn  created from DOT-4 version
*/
...
#endif	/* _POSIX_THREAD_PROCESS_SHARED */
        clockid_t   condAttrClockId;            /* clock ID of timed cond var */
	} pthread_condattr_t;
...
#endif	/* _POSIX_THREAD_PROCESS_SHARED */
        clockid_t               condClockId;  /* clock ID of timed cond var */
	} pthread_cond_t;
...
int pthread_condattr_getclock(const pthread_condattr_t * pAttr,
                              clockid_t *                pClockId);
int pthread_condattr_setclock(pthread_condattr_t * pAttr,
                              clockid_t            clockId);

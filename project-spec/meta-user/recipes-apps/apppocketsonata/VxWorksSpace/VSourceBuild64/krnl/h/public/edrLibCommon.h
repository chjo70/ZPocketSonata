...
/*
 * Copyright (c) 2004, 2014, 2016 Wind River Systems, Inc.
 *
...
23aug04,md   add additional errno values
07jun04,md   add memory map option flag
21may04,md   add option flags
02feb04,md   created
*/

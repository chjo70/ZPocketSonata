...
/*
 * Copyright (c) 2003-2005, 2007-2010, 2013, 2015, 2017
...
#else
#define semRWCreate(options, maxReaders) \
          semMCreate((options))                /* drop maxReaders */
#endif
...
#else
#define semRTake(semId, timeout) \
          semTake((semId), (timeout))

#define semWTake(semId, timeout) \
          semTake((semId), (timeout))
#endif

...
--------------------
11jun15,ljl  Static analysis cleanup, US59005
13may15,h_k  added ipcom_syslog deprecation notice. (F4542)
15apr14,rjq  Update syslog macro for removing some components in vx7.(VXW7-2692)
*/
...
Wind River recommends that you do not use the ipcom_syslog facility.
It will be removed from a future release. Use the syslog library instead.
...
#if (defined(IPCOM_USE_SYSLOG) || (defined(IPCOM_SYSLOG) && IPCOM_SYSLOG != 1)) && !defined(_lint)
...
#define IPCOM_LOG_IPAPPL         (35 << 3)
#define IPCOM_LOG_IPTCP          (36 << 3)
#define IPCOM_LOG_IPMLDS         (37 << 3)
#define IPCOM_LOG_IPEMANATE      (38 << 3)
#define IPCOM_LOG_IPFREESCALE    (39 << 3)
#define IPCOM_LOG_IPMCP          (40 << 3)
#define IPCOM_LOG_IPPRISM        (41 << 3)
#define IPCOM_LOG_IP8021X        (42 << 3)
#define IPCOM_LOG_IPEAP          (43 << 3)
#define IPCOM_LOG_IPSAFENET      (44 << 3)
#define IPCOM_LOG_IPHWCRYPTO     (45 << 3)
#define IPCOM_LOG_IPNETSNMP      (46 << 3)
#define IPCOM_LOG_IPQUAGGA       (47 << 3)
#define IPCOM_LOG_IPDHCPC6       (48 << 3)
#define IPCOM_LOG_IPCCI          (59 << 3)
#define IPCOM_LOG_IPDIAMETER     (50 << 3)
#define IPCOM_LOG_IPROHC     	 (51 << 3)
#define IPCOM_LOG_IPSCTP         (52 << 3)
#define IPCOM_LOG_IPIFPROXY      (53 << 3)
#define IPCOM_LOG_IPCOM_KEY_DB   (54 << 3)
#define IPCOM_LOG_IPWPS     	 (55 << 3)
#define IPCOM_LOG_IPMACSEC     	 (56 << 3)
#define IPCOM_LOG_IPRIPNG        (57 << 3)
#define IPCOM_LOG_IPNTP          (58 << 3)
#define IPCOM_LOG_WRNAD     	 (59 << 3)
#define IPCOM_LOG_IPBRIDGE     	 (60 << 3)
#define IPCOM_LOG_IPFORWARDER  	 (61 << 3)
#define IPCOM_LOG_IPSCEP         (62 << 3)


/* Keep updated! (also update <IPCOM>/src/ipcom_syslog_data.c: ipcom_syslogd_facility_names[] */
#define IPCOM_LOG_FACILITY_MAX   (63)
 ...
 *
 */
#if defined(IPCOM_SYSLOG) && IPCOM_SYSLOG != 1
#define ipcom_syslog IPCOM_SYSLOG
#endif

#if defined(IPCOM_USE_SYSLOG) || defined(IPCOM_USE_CLIB_PROTO)
IP_PUBLIC void

...
--------------------
25may16,ghl  Port TSR defect fix forward from vxworks6.9 into vx7. (F6988)
*/
 ...
 ****************************************************************************
 */
#define IP_ARPOPT_NONPERM 0x02 /*mask for arp option.*/
...
IP_GLOBAL int
ipnet_cmd_neigh_for_each(int family,
                         Ip_u32 ifindex,
                         Ip_bool all_neighbors,
                         int (*cb)(struct Ipnet_rt_msghdr *rt, struct Ip_sockaddr *addrs[]));

IP_GLOBAL int
ipnet_cmd_neigh_for_each_optmask(int family,
                         Ip_u32 ifindex,
                         Ip_bool all_neighbors,
                         int opt_mask,
                         int (*cb)(struct Ipnet_rt_msghdr *rt, struct Ip_sockaddr *addrs[]));

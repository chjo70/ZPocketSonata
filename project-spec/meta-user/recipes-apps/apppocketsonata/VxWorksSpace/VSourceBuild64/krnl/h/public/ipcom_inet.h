...
#define IPCOM_IS_GT64(s1, s2)    ((Ip_s64) ((s1) - (s2)) > 0)
#define IPCOM_IS_GEQ64(s1, s2)   ((Ip_s64) ((s1) - (s2)) >= 0)
#define IPCOM_IS_LT64(s1, s2)    ((Ip_s64) ((s1) - (s2)) < 0)
#define IPCOM_IS_LEQ64(s1, s2)   ((Ip_s64) ((s1) - (s2)) <= 0)
...
/*
 *===========================================================================
 *                    ipcom_getinaddrprefixbyaddr
 *===========================================================================
 * Description:  Converts a prefix in the form addr/len to a numerical form.
 *               Len does not include host specific length, i.e. 32 or 128.
 * Parameters:   domain - Address domain (IP_AF_LINK, IP_AF_INET or IP_AF_INET6).
...
/*
 *===========================================================================
 *                    ipcom_getinaddrprefixbyaddr2
 *===========================================================================
 * Description:  Converts a prefix in the form addr/len to a numerical form.
 *               Len includes host specific length, i.e. 32 and 128.
 * Parameters:   domain - Address domain (IP_AF_LINK, IP_AF_INET or IP_AF_INET6).
 *               straddr - The presentation form of the prefix.
 *               inprefix - Points to a buffer that can hold the domain address.
 *               prefixlen - The length of the prefix.
 ...
 */
IP_PUBLIC int
ipcom_getinaddrprefixbyaddr2(int domain, IP_CONST char *straddr, void *inprefix, int *prefixlen);
 ...
 */
IP_PUBLIC Ip_u32
ipcom_in_checksum_update_pkt(Ipcom_pkt *pkt, Ip_u32 chksum);

/*
 *===========================================================================
 *                    ipcom_in_checksum_pkt
 *===========================================================================
 * Description:   Calculate a one complement checksum.
 * Parameters:    buf and bytes.
 * Returns:       A one complement standard internet checksum.
 ...
 */
IP_PUBLIC Ip_u16
ipcom_in_checksum_pkt(Ipcom_pkt *pkt, Ip_u32 chksum);
 ...
 * Parameters:  stack_instance - pointer to the stack state.
 *                               value returned by ipcom_stackd_init()
 *                               must be passed to every invocation of
 *                               ipcom_stackd_event()
 * Returns:     No of milliseconds to next stack timeout.
 *
 */
IP_PUBLIC Ip_s32 ipcom_stackd_init(void **pstack_instance);
IP_PUBLIC Ip_s32 ipcom_stackd_event(void *stack_instance, Ip_bool is_timeout);

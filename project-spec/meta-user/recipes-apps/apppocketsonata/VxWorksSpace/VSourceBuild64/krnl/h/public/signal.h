...
/*
 * Copyright (c) 1992-1994, 2000, 2003-2006, 2009-2012, 2014 Wind River Systems,
 * Inc.
 *
...
--------------------
04nov14,pcs  Update documentation of struct sigcontext (V7COR-2166).
21jun12,pad  Moved the definition of the sigcontext type from sigLibP.h to
             here since this type is documented (defect 315689).
21mar12,jpb  Moved stack_t and sigset_t definition into their own base 
             header file (part of defect Defect WIND000307800).
06feb12,kk   fix comment to avoid issues with refgen (WIND00259043)
16nov11,yjw  Add si_code FPE_FLTINV.(WIND00310152) 
             pad  Modified values of non-signal-specific subcodes so that they
	     are unique, in agreement with POSIX.1 specs (defect 310142).
26jan11,pad  Use underscored parameter names in function prototypes as
             non-prefixed names violate the POSIX namespace rules (defect
             #248649).
08sep10,cww  Fixed stack_t ss_sp type
15mar10,cww  User side LP64 adaptation
28dec09,jpb  Updated ss_sp field.
10sep09,cww  Kernel side LP64 adaptation
18jun06,gls  added reserved signal definitions
12jun06,pcm  made modifications for pthread cancellation points
14apr06,gls  updated signal number documentation
14mar06,nld  Used macro instead of hard-coded value 64 in sigmask & SIGMASK
             (fix for SPR 119258)
09mar06,gls  added check for 0 in sigmask() and SIGMASK() for performance
17feb06,pes  Move typedef of pid_t and pthread_t. Note that pid_t has
             changed from unsigned short to int by this change.
28jan06,mil  Updated for POSIX namespace conformance.
15feb06,scm  correct sigmask macros...
08dec05,gls  added support for additional POSIX signals
07dec05,gls  added missing POSIX signal definitions
22aug05,kk   updated prototype of sigtimedwait() and sigwaitinfo()
19aug05,kk   updated prototype for RTP sigqueue() to conform to POSIX
04aug05,kk   added sys/types.h to get pid_t for POSIX
07feb05,hya  added missing prototype
30sep04,ans  added _rtpSigqueue()
27sep04,ans  updated job control signals documentation.
13sep04,yvp  Added aliases for posix functions to get API uniformity across
             both kernel/userland.
19may04,ans  alternate signal stack support.
04may04,ans  added SIG_NODEFER
27oct03,nrj  added support for waitpid
17oct03,nrj  added SA_RESTART
14oct03,ans  Moved SIGEV_NONE SIGEV_SIGNAL to sigeventCommon.h
09nov00,jgn  remove inaccurate comment from SIGKILL (SPR #35996)
19jul00,jgn  add thread cancellation signal for pthreads support +
	     update the sigwait prototype to match the POSIX version
11nov94,kdl  provide paramless func ptrs in structs, for non-ANSI (SPR 3742)
10nov94,caf  adjusted placement of _ASMLANGUAGE conditional.
06oct93,yao  added _ASMLANGUAGE conditional.
12jan94,kdl  added sigqueue() prototype.
09nov93,rrr  update to posix 1003.4 draft 14
05feb93,rrr  fixed spr 1986 (SIG_ERR ... prototype) and
	     spr 1906 (signal numbers to match sun os)
15oct92,rrr  silenced warnings
22sep92,rrr  added support for c++
22aug92,rrr  added bsd prototypes.
27jul92,smb  added prototype for raise().
04jul92,jcf  cleaned up.
26may92,rrr  the tree shuffle
19feb92,rrr  written from posix spec
*/
...
/*
 * Signal context information used by the kernel to restore state following 
 * execution of the signal handler. It is also used to provide signal/fault
 * specific information via sc_info and if the signal is generated because
 * of an exception, then sc_pregs points to the register set of the exception.
 * Note: It is used only in the kernel.
 */

struct sigcontext
    {
    int                 sc_onstack; /* unused */
    int                 sc_restart; /* unused */
    sigset_t            sc_mask;    /* signal mask to restore */
    struct siginfo      sc_info;    /* signal/fault specific info */
    REG_SET             sc_regs;    /* task REG_SET prior to handling signal */
                                    /* (REG_SET to restore). */
    REG_SET             *sc_pregs;  /* pointer to REG_SET of ESF if signal is */
                                    /* generated due to an exception. */
    };

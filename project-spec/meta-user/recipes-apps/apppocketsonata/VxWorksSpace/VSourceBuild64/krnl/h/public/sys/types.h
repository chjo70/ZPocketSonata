...
--------------------
03l,06feb12,kk   fix comment block to avoid issues with refgen. (WIND00259043)
03l,31oct11,mze  fix comment for docs
03k,25jan11,pad  No longer includes non-POSIX headers (POSIX namespace
		 conformance, defect #218143).
03j,18may10,pad  Moved extern C statement after include statements.
03i,26jan09,pcs  Updated to add support for LP64 data model.
03h,23jun06,tcr  add POSIX trace types
03g,10mar06,mil  Removed duplicate include of b_pthread_t.h.
03f,01mar06,pes  Add more base types.
03e,16feb06,pes  Move definitions here from other headers for POSIX namespace
                 conformance.
03d,28jan06,mil  Updated for POSIX namespace conformance.
03c,20sep04,job  Fix for SPR#96712
03b,09feb04,mcm  Fix for SPR:93253
03a,16sep03,mcm  included vxTypesBase.h and vxTypesOld.h header files to 

...
/*
 * Copyright (c) 1990-1992, 1994, 1996-1997, 1999, 2001, 2003-2010, 2014 - 2015, 2017
...
--------------------
16jun17,msx  Added _WRS_UNIT_TEST to include some definitions for unit test.
09mar15,pcs  CERT: flexelint fix, Changed the macro WAIT_FOREVER from -1U to
             0xFFFFFFFFU
...
#define __INCvxWorksCommonh
     ...
     !defined(_POSIX_AEP_RT_CONTROLLER_C_SOURCE)) || defined(_WRS_UNIT_TEST)

...
--------------------
04jun17,dlk  add IPCOM_ERR_TASK_DOOMED (F5593)
...
/*security event ID*/
#define SEC_EVENT_TELNET_LOGIN_FAILED  (M_inetLib | 1)
#define SEC_EVENT_RLOGIN_LOGIN_FAILED  (M_inetLib | 2)
#define SEC_EVENT_TELNET_LOGIN_OK      (M_inetLib | 3)
#define SEC_EVENT_RLOGIN_LOGIN_OK      (M_inetLib | 4)
#define SEC_EVENT_TELNET_LOGOUT        (M_inetLib | 5)
#define SEC_EVENT_RLOGIN_LOGOUT        (M_inetLib | 6)
...
/* Operation returned early because of a task deletion attempt */
#define IPCOM_ERR_TASK_DOOMED         -1124

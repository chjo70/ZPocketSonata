...
struct Ipnet_tag_nc_entry
{
    ...
    /*
     * F1: Filled by caller
     * F2: Filled by caller for ADD, by callee for GET and unused for
     *     DEL
     */

    /* F1: Virtual router to use (0 = default) */
    Ip_u16            vr_index;
    /*
     * F1: Interface index. Can be 0 in ADD to let the stack select
     * the interface.
     */
    Ip_u32            ifindex;
    /* F1: A IPv6 address  */
    ...
    /* F2: Is this a router */
    Ip_bool           is_router;
    /* F2: Will this node answers to solicitations to this entry */
    Ip_bool           is_publ;
    /*
     * F2: Number of seconds before the entry expires (or
     * IPNET_INFINTE)
     */
    Ip_u32            expires_sec;
...
/* Get information about a neighbor cache entry */
#define IPNET_CTRL_GET_NC_ENTRY        (IPNET_CTRL_NC_ENTRY_BASE | 1)

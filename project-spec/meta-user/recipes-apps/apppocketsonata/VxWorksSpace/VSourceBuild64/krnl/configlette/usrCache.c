...
/*
 * Copyright (c) 1998, 2012 , 2013 Wind River Systems, Inc.
 *
...
--------------------
22oct13,xms  fix CHECKED_RETURN error. (WIND00414265)
05dec12,h_k  fixed dependency issues.
10nov12,h_k  changed the L2CSR1 setting configurable for e6500.
01nov12,x_s  added cache configuration for e6500.
02jun98,ms   written
*/
...
#   endif /* INCLUDE_L3_CACHE */
    ...
    (void) cacheEnable (INSTRUCTION_CACHE);            /* enable instruction cache */
#endif  /* USER_I_CACHE_ENABLE */

#ifdef  USER_D_CACHE_ENABLE
    /* don't need return from function call */

    (void) cacheEnable (DATA_CACHE);                   /* enable data cache */
#endif  /* USER_D_CACHE_ENABLE */

#if	defined(USER_B_CACHE_ENABLE) && (CPU==MC68060)
    /* don't need return from function call */

    (void) cacheEnable (BRANCH_CACHE);                 /* enable branch cache */

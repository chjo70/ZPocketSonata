...
/*
 * Copyright (c) 2004-2005, 2007, 2009, 2011, 2014 Wind River Systems, Inc.
 *
...
--------------------
13mar14,x_z  Removed aimCacheSysctlInit(). (US18830)
25jan11,pcs  Changed the handler for KERN_AUXCLOCKRATE from
...
04dec09,jpb  Updated return types for SYSCTL_ACCESS members.
31aug07,rec  WIND00103242 archSysctlInit not included for coldfire
01jun07,pad  Replaced inclusion of sys/sysctl.h with private/sysctlP.h.
05feb07,jmt  Fix compiler warning with missing archSysctlInit prototype
05sep05,elp  adding archSysctlInit() for simulators.
01dec04,rec  updated for PPC
30sep04,h_k  added SH support.
13sep04,rec  add ARM/XScale support
24aug04,job  Fix warning: SPR #100114
28jun04,mdo  SPRs 98476, 98481, 98482, 98472, 98473
01jul04,job  Register auxClkRate sysctl here because it must be done
	 conditionally as not all BSPs support it.
28jun04,job  Updated prototype inclusion to remove warnings
09jun04,zl   removed reference to vxVMI
08jun04,job  Removed sys|auxClkRate, sysModel & sysBspRev routines to
             RTP bring up code.
08jun04,sru  all MMU's now layered underneath MMU AIM, so removed
	 call to PPC-specific mmuArchSysctlInit().
02jun04,rec  renamed file from usrSysctl.c to usrHwSysctl.c
01jun04,mem  call aim*SysctlInit() for all architectures
20may04,mem  call archSysctlInit() for MIPS
05may04,rec  move cache and mmu leaves to arch files
09apr04,rec  review comments
25mar04,rec  written
*/

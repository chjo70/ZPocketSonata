...
#define UINT8_C(x)	((_CSTD uint_least8_t)+((x) + 0U))
#define UINT16_C(x)	_CONCAT(x,U)
#define UINT32_C(x)	_CONCAT(x,U)
...
#define INT64_C(x)		_CONCAT(x,LL)
#define UINT64_C(x)		_CONCAT(x,ULL)

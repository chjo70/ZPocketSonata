...
--------------------------
29dec16,rjq  remove useless parameter in Ipcom_pkt_struct (V7NET-1217)
...
#define IPCOM_NONETH_SET_LINKINFO(_pkt, _llsize, _type) \
    (_pkt)->link_cookie = (Ip_ptrdiff_t)((((_llsize) << 16) & 0xFFFF0000) | ((_type) & 0x0000FFFF))
#define IPCOM_NONETH_GET_LLSIZE(_pkt) \
    ((((Ip_u32)((_pkt)->link_cookie)) >> 16) & 0xFFFF)
#define IPCOM_NONETH_GET_TYPE(_pkt) \
    (((Ip_u32)((_pkt)->link_cookie)) & 0xFFFF)
#endif
...
#define IPCOM_PKT_FLAG_READONLY       (1 << 2)    /* IPNET: This packet is read only. */
                                   ...
                                   )
{
    ...
    /*
     * Scatter-gather buffer. Length is the sum of all packet in the chain.
     */

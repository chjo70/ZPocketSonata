...
_EXTERN_CONST_DECL _Dconst _Denorm, _Hugeval, _Inf,
	_Nan, _Snan;
...
_EXTERN_CONST_DECL _Dconst _FDenorm, _FInf, _FNan, _FSnan;
...
_EXTERN_CONST_DECL _Dconst _LDenorm, _LInf, _LNan, _LSnan;

...
--------------------
20may17,dlk  added taskDelayEx() prototype and TASK_DELAY_EX_DELETION_WAKEUP
             flag, and taskSafeTcbGet()/taskSafeTcb()/taskUnsafeTcb()/
             taskWindTcbCurrent()/taskWindTcbToTaskId()/taskDoom() (F5593)
...
#include <arch/simcommon/coprocSimpentium.h>
...
extern TASK_ID taskWindTcbToTaskId (struct windTcb * pTcb);

...
/*
Up to WRS GNU 4.8.1.4, the size of wchar_t is 2 bytes. If this
changes in the future, the definition here should be changed accordingly.
*/

 #if defined(__MINGW32__) || defined (_IS_WRS)
  #define _WCHAR_T_SIZE		2

...
/*
 * Copyright (c) 1999, 2001-2006, 2014 Wind River Systems, Inc.
 *
...
--------------------
12may14,l_z  Decouple the generic mii library to vxbMiiLib.c. (US33490)
06jan14,p_x  include lstLib.h (WIND00447891)
11jan06,wap  Add MII_SR_EXT_STS bit for extended status
05jan06,wap  Add definition for MII_CR_1000
22apr04,kp   added the macro MII_SR_SPEED_SEL_MASK
06aug03,slk  added phyFlags option MII_PHY_ISO_UNAVAIL SPR# 90115
13may02,rcs  added pPhyOptRegsRtn field to PHY_INFO. SPR# 76711
14jun01,rcs  moved new registers used by GMII to new struc MII_G_REGS
                and placed it at end of PHY_INFO. (SPR# 68502)
23feb01,jln  add basic GMII support for 1000-T auto-negotiation (SPR# 68502)
23nov99,cn   added miiLibInit () to make miiLib a component (SPR #29542).
08nov99,cn   added fields phyLinkDownRtn, pMiiPhyNode, miiPhyPresent
...
27sep99,cn   added definition of MII_CR_DEF_0_MASK.
13sep99,cn   added definition of MII_MAX_REG_NUM, moved global APIs
		from miiLib.c (SPR# 28305).
15jun99,cn	 changes after the code review.
16mar99,cn	 written from motFccEnd.h, 01b.
*/

/*
DESCRIPTION

This module implements a Media Independent Interface (MII) library for FDT
type device.
...
#   define MII_MONITOR_DELAY   0x2		/* in seconds */
#endif

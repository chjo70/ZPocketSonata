...
#define IP_NETLINK_SECY                     1       /* MACsec hook                                  */
#define IP_NETLINK_BRIDGE                   2       /* Bridge hook                                  */
#define IP_NETLINK_XFRM                     6       /* XFRM - IPSEC                                 */
#define IP_NETLINK_MAX                      7
...
#define IP_NLA_ALIGNTO             4u
#define IP_NLA_ALIGN(len)          (((len) + IP_NLA_ALIGNTO - 1) & ~(IP_NLA_ALIGNTO - 1))
#define IP_NLA_HDRLEN              (IP_NLA_ALIGN(sizeof(struct Ip_nlattr)))
...
enum {
        ...
        IP_RTM_NEWSACACHE   = 116,
        IP_RTM_DELSACACHE   = 117,
        IP_RTM_GETSACACHE   = 118,
#endif
	...
	IP_RTM_DELSVLAN,
        ...
        IP_RTM_NEWFWCACHE   = 124,
        IP_RTM_DELFWCACHE   = 125,
        IP_RTM_GETFWCACHE   = 126,
        ...
        IP_RTM_NEWTCPMKT       = 132,
        IP_RTM_DELTCPMKT,
        IP_RTM_GETTCPMKT,
        IP_RTM_CHANGETCPMKT,

        IP_RTM_ADDRCONFLICT    = 139,
        /* <<< CONFIG INTERPEAK */
...
#define IP_RTA_OK(rta,len)          ((len) >= (int)sizeof(struct Ip_rtattr) && \
                                    ...
                                    (rta)->rta_len <= (len))
#define IP_RTA_NEXT(rta,attrlen)    ((attrlen) -= (Ip_size_t)IP_RTA_ALIGN((rta)->rta_len), \
...
struct Ip_rtnl_link_stats
{
        ...
        Ip_u64   rx_bytes;               /* total bytes received         */
        Ip_u64   tx_bytes;               /* total bytes transmitted      */
...
struct Ip_rtnl_link_stats64
{
        Ip_u64   rx_packets;             /* total packets received       */
        Ip_u64   tx_packets;             /* total packets transmitted    */
        Ip_u64   rx_bytes;               /* total bytes received         */
        Ip_u64   tx_bytes;               /* total bytes transmitted      */
        Ip_u64   rx_errors;              /* bad packets received         */
        Ip_u64   tx_errors;              /* packet transmit problems     */
        Ip_u64   rx_dropped;             /* no space in linux buffers    */
        Ip_u64   tx_dropped;             /* no space available in linux  */
        Ip_u64   multicast;              /* multicast packets received   */
        Ip_u64   collisions;

        /* detailed rx_errors: */
        Ip_u64   rx_length_errors;
        Ip_u64   rx_over_errors;         /* receiver ring buff overflow  */
        Ip_u64   rx_crc_errors;          /* recved pkt with crc error    */
        Ip_u64   rx_frame_errors;        /* recv'd frame alignment error */
        Ip_u64   rx_fifo_errors;         /* recv'r fifo overrun          */
        Ip_u64   rx_missed_errors;       /* receiver missed packet       */

        /* detailed tx_errors */
        Ip_u64   tx_aborted_errors;
        Ip_u64   tx_carrier_errors;
        Ip_u64   tx_fifo_errors;
        Ip_u64   tx_heartbeat_errors;
        Ip_u64   tx_window_errors;

        /* for cslip etc */
        Ip_u64   rx_compressed;
        Ip_u64   tx_compressed;
};
...
enum
{
        ...
        IP_IFLA_NET_NS_PID,
        IP_IFLA_IFALIAS,
        IP_IFLA_NUM_VF,            /* Number of VFs if device is SR-IOV PF */
        IP_IFLA_VFINFO_LIST,
        IP_IFLA_STATS64,
        IP_IFLA_VF_PORTS,
        IP_IFLA_PORT_SELF,
...
{
    IP_IFLA_BOND_UNSPEC,
    IP_IFLA_BOND_XMIT_POLICY,
    IP_IFLA_BOND_LAG_MEMBER,
	__IP_IFLA_BOND_MAX
};

#define IP_IFLA_BOND_MAX   (__IP_IFLA_BOND_MAX - 1)

struct Ip_ifla_bond_lag {
    Ip_u32 ifindex;
    Ip_u32 enabled;
};
...
enum
{
        IP_IFLA_TUNNEL_UNSPEC,
        IP_IFLA_TUNNEL_MODE,
        IP_IFLA_TUNNEL_LOCAL,
        IP_IFLA_TUNNEL_REMOTE,
        IP_IFLA_TUNNEL_IKEY,
        IP_IFLA_TUNNEL_OKEY,
        IP_IFLA_TUNNEL_ISEQ,
        IP_IFLA_TUNNEL_OSEQ,
        IP_IFLA_TUNNEL_ICSUM,
        IP_IFLA_TUNNEL_OCSUM,
        IP_IFLA_TUNNEL_TTL,
        __IP_IFLA_TUNNEL_MAX
};

#define IP_IFLA_TUNNEL_MAX   (__IP_IFLA_TUNNEL_MAX - 1)
...
#define IP_RTMGRP_LINK             IP_NLMSG_GROUP_MASK(IP_RTNLGRP_LINK)
#define IP_RTMGRP_NOTIFY           IP_NLMSG_GROUP_MASK(IP_RTNLGRP_NOTIFY)
#define IP_RTMGRP_NEIGH            IP_NLMSG_GROUP_MASK(IP_RTNLGRP_NEIGH)
#define IP_RTMGRP_TC               IP_NLMSG_GROUP_MASK(IP_RTNLGRP_TC)

#define IP_RTMGRP_IPV4_IFADDR      IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV4_IFADDR)
#define IP_RTMGRP_IPV4_MROUTE      IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV4_MROUTE)
#define IP_RTMGRP_IPV4_ROUTE       IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV4_ROUTE)
#define IP_RTMGRP_IPV4_RULE        IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV4_RULE)

#define IP_RTMGRP_IPV6_IFADDR      IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV6_IFADDR)
#define IP_RTMGRP_IPV6_MROUTE      IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV6_MROUTE)
#define IP_RTMGRP_IPV6_ROUTE       IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV6_ROUTE)
#define IP_RTMGRP_IPV6_IFINFO      IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV6_IFINFO)
#define IP_RTMGRP_IPV6_RULE        IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV6_RULE)

#define IP_RTMGRP_DECnet_IFADDR    IP_NLMSG_GROUP_MASK(IP_RTNLGRP_DECnet_IFADDR)
#define IP_RTMGRP_DECnet_ROUTE     IP_NLMSG_GROUP_MASK(IP_RTNLGRP_DECnet_ROUTE)

#define IP_RTMGRP_IPV6_PREFIX      IP_NLMSG_GROUP_MASK(IP_RTNLGRP_IPV6_PREFIX)
/* CONFIG INTERPEAK >>> */
#define IP_RTMGRP_RTAB             IP_NLMSG_GROUP_MASK(IP_RTNLGRP_RTAB)
/* <<< CONFIG INTERPEAK */
...
enum
{
    IP_NETLINK_TRANSLATE_IPNET,
    IP_NETLINK_TRANSLATE_LINUX
};

/* NAE FORWARDING IFPROXY TYPES */
enum
{
    IP_IFPROXY_UNSPEC,
    IP_IFPROXY_PORT_INDEX,
    IP_IFPROXY_MIPC_PORT,
    IP_IFPROXY_IFNAME,
    IP_IFPROXY_CORES,
    IP_IFPROXY_RESET,
    IP_IFPROXY_STATS_DRIVER,
    IP_IFPROXY_STATS_STACK,

    __IP_IFPROXY_MAX
};

#define IP_IFPROXY_MAX   (__IP_IFPROXY_MAX - 1)
...
#define IP_FWC_MAX (__IP_FWC_MAX - 1)

#define IP_FWC_RTA(r)       ((struct Ip_rtattr*)(((char*)(r)) + IP_NLMSG_ALIGN(sizeof(struct Ip_fwcmsg))))
#define IP_FWC_PAYLOAD(n)   IP_NLMSG_PAYLOAD(n,sizeof(struct Ip_fwcmsg))
...
#define IP_SAC_MAX (__IP_SAC_MAX - 1)

#define IP_SAC_RTA(r)       ((struct Ip_rtattr*)(((char*)(r)) + IP_NLMSG_ALIGN(sizeof(struct Ip_sacmsg))))
#define IP_SAC_PAYLOAD(n)   IP_NLMSG_PAYLOAD(n,sizeof(struct Ip_sacmsg))
...
enum
{
    ...
    IP_NAE_TICK_COUNT,
    IP_NAE_TICK_HZ,
    IP_NAE_FWCACHE_ROUTE_CACHE_ID,
    IP_NAE_FWCACHE_SELECTIVE_INVALID,
    IP_NAE_FWCACHE_TOTAL_INVALID,
    IP_NAE_FWCACHE_INVALID_DELETE,
    IP_NAE_FWCACHE_INVALID_LLADDR,
    IP_NAE_FWCACHE_INVALID_INCOMPLETE,
    IP_NAE_FWCACHE_COLLISSIONS,
    IP_NAE_FWCACHE_COLLISSIONS_INVALIDATE,
    IP_NAE_FWCACHE_CURRENT_INET,
    IP_NAE_FWCACHE_CURRENT_INET6,
    IP_NAE_FWCACHE_TOTAL_INET,
    IP_NAE_FWCACHE_TOTAL_INET6,
    IP_NAE_FWCACHE_NEIGH_DELETE_TIMEOUT,
    IP_NAE_FWCACHE_NEIGH_DELETE_EXTERNAL,
    IP_NAE_FWCACHE_NEIGH_DELETE_GARBAGE_COLLECT,
    IP_NAE_FWCACHE_NEIGH_DELETE_FLUSHED,
    IP_NAE_FWCACHE_NEIGH_DELETE_FAILED,
    IP_NAE_FWCACHE_NEIGH_DELETE_RESOURCE,
    IP_NAE_PKT_POOL,
    IP_NAE_CAPABILITY,
    __IP_NAE_MAX
};
#define IP_NAE_MAX (__IP_NAE_MAX - 1)

enum
{
    IP_NAE_PKTPOOL_UNSPEC,
    IP_NAE_PKTPOOL_NAME,
    IP_NAE_PKTPOOL_SIZE,
    IP_NAE_PKTPOOL_AVAIL,
    IP_NAE_PKTPOOL_MTU,
    IP_NAE_PKTPOOL_NUMA,
    __IP_NAE_PKTPOOL_MAX
};
#define IP_NAE_PKTPOOL_MAX (__IP_NAE_PKTPOOL_MAX - 1)

enum
{
    IP_NAE_CAPABILITY_UNSPEC,
    IP_NAE_CAPABILITY_NAME,
    IP_NAE_CAPABILITY_VALUE,
    __IP_NAE_CAPABILITY_MAX
};
#define IP_NAE_CAPABILITY_MAX (__IP_NAE_CAPABILITY_MAX - 1)

enum
{
    IP_NAE_NETIF_UNSPEC,
    IP_NAE_NETIF_IFINDEX,
    __IP_NAE_NETIF_MAX
};
#define IP_NAE_NETIF_MAX (__IP_NAE_NETIF_MAX - 1)

#define IP_NAE_RTA(r)       ((struct Ip_rtattr*)(((char*)(r)) + IP_NLMSG_ALIGN(sizeof(struct Ip_naemsg))))
#define IP_NAE_PAYLOAD(n)   IP_NLMSG_PAYLOAD(n,sizeof(struct Ip_naemsg))
 ...
 ****************************************************************************
 */
IP_GLOBAL struct Ip_rtattr *ipcom_netlink_addattr_l(struct Ip_nlmsghdr *n, Ip_size_t max_size, int type, const void *rta_data, Ip_size_t rta_len);
IP_GLOBAL struct Ip_rtattr *ipcom_netlink_rta_addattr_l(struct Ip_rtattr *rta_nest, Ip_size_t max_size, int type, const void *rta_data, Ip_size_t rta_len);
IP_GLOBAL void ipcom_netlink_addattr_l_end(struct Ip_nlmsghdr *n, struct Ip_rtattr *rta);
IP_GLOBAL struct Ip_rtattr *ipcom_netlink_addattr_l_begin(struct Ip_nlmsghdr *n, int max_size, int type);
IP_GLOBAL struct Ip_nlmsghdr *ipcom_netlink_nlmsghdr_init(void *buf, int type, int flags, int hdrsize);


IP_GLOBAL void ipcom_netlink_rtnl_translate(int to, int from, struct Ip_nlmsghdr *nlh);

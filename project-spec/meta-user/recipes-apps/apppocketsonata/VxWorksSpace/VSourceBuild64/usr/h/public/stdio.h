...
#ifndef _VA_LIST
#if defined(_WR_VA_LIST_IN_STDIO) || \
    (defined(_POSIX_C_SOURCE) && _POSIX_C_SOURCE >= 200809L) || \
    defined(_XOPEN_SOURCE) || \
    defined(_POSIX_AEP_RT_CONTROLLER_C_SOURCE)  /* XSI options */
typedef _va_list va_list;
#define _VA_LIST
#if defined(_C_IN_NS) && defined(__cplusplus)
_C_STD_BEGIN
typedef ::va_list va_list;
_C_STD_END
#endif /* _C_IN_NS etc */
#endif /* XSI options */
#elif defined(_CLANG) && _CLANG /* _VA_LIST */
#if defined(_C_IN_NS) && defined(__cplusplus)
using _CSTD va_list;
#endif /* _C_IN_NS etc */
#endif /* _VA_LIST */
...
#define stderr		(&_CSTD _Stderr)
  ...
  #ifndef _NO_WINDRIVER_MODIFICATIONS
   #define _Trylockfile(str)     (void)0
  #endif /* _NO_WINDRIVER_MODIFICATIONS */
 #endif /* _MULTI_THREAD */
...
#if defined(__RTP__)
char *ctermid(char *);
void flockfile(_CSTD FILE *);
int fseeko(_CSTD FILE *, off_t, int);
off_t ftello(_CSTD FILE *);
int ftrylockfile(_CSTD FILE *);
void funlockfile(_CSTD FILE *);
int getc_unlocked(_CSTD FILE *);
int getchar_unlocked(void);
int pclose(_CSTD FILE *);
_CSTD FILE *popen(const char *, const char *);
int putc_unlocked(int, _CSTD FILE *);

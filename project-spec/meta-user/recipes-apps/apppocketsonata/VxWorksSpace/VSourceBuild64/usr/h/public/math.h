...
#if defined(__DCC__) && !defined(_NO_WINDRIVER_MODIFICATIONS)
#define _DCC_FLOAT_BUG 1
#endif /* __DCC__ etc */
  ...
  #define NAN		__NAN__
	...
	|| 4 <= __GNUC__ && 8 <= __GNUC_MINOR__ && defined(_DCC_FLOAT_BUG)

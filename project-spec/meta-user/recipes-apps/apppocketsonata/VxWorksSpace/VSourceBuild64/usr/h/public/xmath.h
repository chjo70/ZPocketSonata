...
_EXTERN_CONST_DECL _Dconst _Eps, _Rteps;
_EXTERN_CONST_DECL double _Zero;
...
float __attribute__((overloadable)) _FPoly(float,
	const float *, int);
float __attribute__((overloadable)) _FPoly(float,
...
_EXTERN_CONST_DECL _Dconst _FEps, _FRteps;
_EXTERN_CONST_DECL float _FZero;
...
_EXTERN_CONST_DECL _Dconst _LEps, _LRteps;
_EXTERN_CONST_DECL long double _LZero;

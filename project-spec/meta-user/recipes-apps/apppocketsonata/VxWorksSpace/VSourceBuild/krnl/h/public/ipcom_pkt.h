...
31may17,wfl  fix tcp throughput drops with all zero data (V7NET-1353)
...
typedef struct Ipcom_pkt_struct
{
    ...
    Ip_bool zero_data; /* set if all of the data is 0 or the data's pkg->chk just is 0 when sending */
...
#define PKT_PRIORITY_FLAGS_SR2       0x4 /* Stream Reservation 2 */
       ...
       Ip_u64 launch_time;  /* used to set the launch time */
#endif

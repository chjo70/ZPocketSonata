...
{
    /*
     * Maximum number of messages that can be queued on this pipe
     */
    unsigned msg_limit;
    /*
     * optional; ID of the job queue this pipe is associated with
     */
    int job_q_id;
    /*
     * optional; function that knows how to process the messages on
     * this pipe.
     */
    void (*handler)(void*);
    /*
     * optional; user defined argument that will be passed to each

...
/*
 * Copyright 2004, 2006, 2010, 2012, 2017 Wind River Systems, Inc.
 *
...
09mar12,txu  Fixed defect WIND00308200: When enabled larger UDP packet,
             using "ls" to list a large dir will cause the shell hang.
29apr10,pad  Moved extern C statement after include statements.
07sep06,mwv  update include paths
18apr06,pcm  simplified structures
10apr06,pcm  modified types to be more strict (SPR 116471)
07apr06,pcm  modified to work with GNU C++ compiler (SPR 115541)
07jan04,ijm  correct data types for xdr_u_longlong_t, SPR#92849
*/
...
union u_cookieverf3
    {
    char cookie[NFS3_COOKIEVERFSIZE];
    uint32 value;
    };

typedef union u_cookieverf3 cookieverf3;
...
extern  bool_t xdr_cookieverf3 (XDR *, caddr_t);

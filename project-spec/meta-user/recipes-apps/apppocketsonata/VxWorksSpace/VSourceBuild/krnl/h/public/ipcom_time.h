...
16jul15,h_x Fix V7NET-595
15jun15,rjq  Add ipcom_adjtime() support. (V7NET-498)
*/
...
#ifndef IP_TIMESPEC_TYPE
#define IP_TIMESPEC_TYPE
struct Ip_timespec
{
    Ip_time_t  tv_sec;      /* Seconds. */
...
IP_PUBLIC int
ipcom_gettimeofday(struct Ip_timeval *tp, void *null_ptr);
#endif
...
IP_PUBLIC int
ipcom_settimeofday(struct Ip_timeval *tp, void *null_ptr);
#endif

#if defined(IPCOM_ADJTIME) && IPCOM_ADJTIME != 1
#define ipcom_adjtime IPCOM_ADJTIME
#elif !defined(IPCOM_ADJTIME)
#define ipcom_adjtime adjtime
#endif

#if (defined(IPCOM_ADJTIME) && IPCOM_ADJTIME == 1) || defined(IPCOM_USE_CLIB_PROTO)
IP_PUBLIC int
ipcom_adjtime(struct Ip_timeval *delta, struct Ip_timeval *olddelta);
#endif
...
#if ((defined(IPCOM_TIME) && IPCOM_TIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
...
#if ((defined(IPCOM_STRFTIME) && IPCOM_STRFTIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
IP_PUBLIC Ip_size_t
...
#if ((defined(IPCOM_GMTIME) && IPCOM_GMTIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
...
#if ((defined(IPCOM_GMTIME_R) && IPCOM_GMTIME_R == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
IP_PUBLIC struct Ip_tm *
...
#if ((defined(IPCOM_LOCALTIME) && IPCOM_LOCALTIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
IP_PUBLIC struct Ip_tm *
...
#if ((defined(IPCOM_LOCALTIME_R) && IPCOM_LOCALTIME_R == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
IP_PUBLIC struct Ip_tm *
...
#if ((defined(IPCOM_ASCTIME) && IPCOM_ASCTIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
IP_PUBLIC char *
...
#if ((defined(IPCOM_CTIME) && IPCOM_CTIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)
IP_PUBLIC char *
...
#if ((defined(IPCOM_MKTIME) && IPCOM_MKTIME == 1) || defined(IPCOM_USE_CLIB_PROTO))&& !defined(_WRS_UNIT_TEST)

 ...
 *               2006, 2014,2017 Wind River Systems, Inc.
 *
...
--------------------
17apr17,chm  NetDrv enhancements to support mv() and mkdir(). (F8223)
09jan12,h_x  Move extern "C" after last header file include.
29sep10,h_x  Add extern FUNCPTR _func_ftpLs
27jul09,zhr  64bits adatation
22oct08,spw  Fix for WIND00135072
16feb06,mwv  Add ftpLibInit, and ftpLs (SPR 117425)
...
09may03,vvv  included vxWorks.h and vwModNum.h
06jun02,elr  Change return for ftpTransientFatalInstall()
23may02,elr  added temporary global flag to bypass PASSIVE mode
22may02,elr  Changed API of ftpCommandEnhanced() and ftpReplyGetEnhanced()
             for PASSIVE mode support
             Added function ftpDataConnInitPassiveMode ()
             Added ftpLibDebugOptionsSet()
12mar02,elr  Added error return codes
             Replaced ftpErrorSuppress with ftplDebug (SPR 71496)
22sep92,rrr  added support for c++
11sep92,jmm  added external definition for ftpErrorSupress (for spr #1257)
04jul92,jcf  cleaned up.
26may92,rrr  the tree shuffle
04oct91,rrr  passed through the ansification filter
		     -fixed #else and #endif
		     -changed copyright notice
19oct90,shl  changed ftpCommand() to use variable length argument list.
05oct90,shl  added ANSI function prototypes.
             made #endif ANSI style.
             added copyright notice.
07aug90,shl  added INCftpLibh to #endif.
20mar87,dnw  prepended FTP_ to reply codes.
07nov86,dnw  written
*/
...
#define FTP_CURRENT_DIRECTORY        257
#define FTP_CWD_DIRECTORY_OK         250
...
extern STATUS ftpLibInit (long timeout);
...
extern int ftpCommand (int ctrlSock, char *fmt, _Vx_usr_arg_t arg1, _Vx_usr_arg_t arg2, _Vx_usr_arg_t arg3, _Vx_usr_arg_t arg4, _Vx_usr_arg_t arg5, _Vx_usr_arg_t arg6);

extern int ftpCommandEnhanced (int ctrlSock, char *fmt, _Vx_usr_arg_t arg1, _Vx_usr_arg_t arg2, _Vx_usr_arg_t arg3, _Vx_usr_arg_t arg4, _Vx_usr_arg_t arg5, _Vx_usr_arg_t arg6, char *replyString, int replyStringLength);

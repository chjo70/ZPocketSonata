...
26oct16,rjq  Changing IP_SS_MAXSIZE to be 128. (V7NET-1133)
16feb16,wfl Support bind() of AF_PACKET for (V7NET-764)
02feb16,h_l  Add IEEE1588 timestamp support.
09dec15,dlk Add IP_SIOCSNDASYNC, deprecate IP_SIOCSSNDMSGAYNC.
            Add IP_MSG_EXP definition.
30jun15,h_x Support asynchronous processing in ipcom_sendmsg() (US60556/V7NET-572)
12feb15,jxy Change IP_FD_SETSIZE default value to 2048
04sep14,zan ROHC multi instance support
10feb14,tlu Add EPOLL socket event callback
*/
...
#if defined(IPTESTENGINE) && defined(IPSSL)
/* Increase number of sockets for SSL test case s_time, pending a fix for WIND00241082 */
#define IP_FD_SETSIZE     10240
#else
#if defined(_WRS_CONFIG_NET_SOCK_MAX)
#define IP_FD_SETSIZE     _WRS_CONFIG_NET_SOCK_MAX
#else
#define IP_FD_SETSIZE     2048
#endif
#endif /* defined(IPTESTENGINE) && defined(IPSSL) */
...
/* The maximum length of a TSN ascii string name */
#define IP_TSN_STREAMNAMSIZ       16
...
#define IP_AF_MIPC     34
#define IP_AF_MIPC_SAFE 35   /* SafeIPC */
#define IP_AF_MAX      36
...
#define IP_IPPROTO_UDPLITE      136 /* UDP-Lite (RFC3828) */
#define IP_IPPROTO_ROHC         142 /* Robust Header Compression RFC5858 */
...
#define IP_MSG_EXP                0x200  /* COMP-only: send express message */

#define IP_MSG_TX_TIMESTAMP       0x400 /* set this flag if up layer need tx timestamp*/
...
#define IP_NETMASK(xxip) \
    (((xxip) == (Ip_u32)0U)   ? (Ip_u32)0U :                            \
...
#define IP_NETBITS(xxip)         ((Ip_s16) (((xxip) == (Ip_u32)0U)  ? 0 : \
                 IP_IN_CLASSA((xxip)) ?  8 : \
...
#define	IP_IN_CLASSA_NET	ip_htonl(((Ip_u32)0xff000000U)) /*lint !e778 */
#define	IP_IN_CLASSB_NET	ip_htonl(((Ip_u32)0xffff0000U)) /*lint !e778 */
#define	IP_IN_CLASSC_NET	ip_htonl(((Ip_u32)0xffffff00U)) /*lint !e778 */
#define IP_IN_CLASSD_NET        ip_htonl(((Ip_u32)0xf0000000U)) /*lint !e778 */

#ifdef IP_LITTLE_ENDIAN
#define	IP_IN_CLASSA(xxip)	((((Ip_u32)(xxip)) & 0x00000080U) == (Ip_u32)0U)
#define	IP_IN_CLASSB(xxip)	((((Ip_u32)(xxip)) & 0x000000c0U) == (Ip_u32)0x00000080U)
#define	IP_IN_CLASSC(xxip)	((((Ip_u32)(xxip)) & 0x000000e0U) == (Ip_u32)0x000000c0U)
#define	IP_IN_CLASSD(xxip)	((((Ip_u32)(xxip)) & 0x000000f0U) == (Ip_u32)0x000000e0U)
#define	IP_IN_EXPERIMENTAL(xxip) ((((Ip_u32)(xxip)) & 0x000000f0U) == (Ip_u32)0x000000f0U)
#elif defined(IP_BIG_ENDIAN)
#define	IP_IN_CLASSA(xxip)	((((Ip_u32)(xxip)) & 0x80000000U) == (Ip_u32)0U)
#define	IP_IN_CLASSB(xxip)	((((Ip_u32)(xxip)) & 0xc0000000U) == (Ip_u32)0x80000000U)
#define	IP_IN_CLASSC(xxip)	((((Ip_u32)(xxip)) & 0xe0000000U) == (Ip_u32)0xc0000000U)
#define	IP_IN_CLASSD(xxip) 	((((Ip_u32)(xxip)) & 0xf0000000U) == (Ip_u32)0xe0000000U)
#define	IP_IN_EXPERIMENTAL(xxip) ((((Ip_u32)(xxip)) & 0xf0000000U) == (Ip_u32)0xf0000000U)
#endif
...
#define IP_SO_CONNTIMEO     0x100a  /* connection timeout for */

#define IP_SO_TIMESTAMP     0x0400
#define IP_SO_TIMESTAMPING  0x0800

#define IP_SO_X_QBV         0x1031  /* char[TSN_STREAMNAMESIZ]; send with launch time defined by Qbv stream*/


#define IP_SOF_TIMESTAMPING_TX_HARDWARE   (1<<0)
#define IP_SOF_TIMESTAMPING_TX_SOFTWARE   (1<<1)
#define IP_SOF_TIMESTAMPING_RX_HARDWARE   (1<<2)
#define IP_SOF_TIMESTAMPING_RX_SOFTWARE   (1<<3)
#define IP_SOF_TIMESTAMPING_SOFTWARE      (1<<4)
#define IP_SOF_TIMESTAMPING_RAW_HARDWARE  (1<<5)
...
#define IP_IP_MULTICAST_TTL     10  /* Ip_u8 or int; Time to live for multicast packets (0 = defalt value) */
...
#define IP_IP_ROUTER_ALERT      21  /* Ip_u8; != 0 if this socket
                                       should receive IP-datagrams
                                       with the router alert option set. */
#define IP_IP_DONTFRAG          22  /* Ip_u8; != 0 set the DF bit on each packet sent from this socket */
#define IP_IP_NOLOCALFRAG       23  /* int; enable/disable support for local fragmentation
                                       (default off, which means that local fragmentation is allowed) */
...
#define IP_IP_AUTH_LEVEL		60  /* int; authentication used (NAE only) */
#define IP_IP_ESP_TRANS_LEVEL	61  /* int; transport encryption (NAE only) */
#define IP_IP_ESP_NETWORK_LEVEL	62  /* int; full-packet encryption (NAE only) */
#define IP_IP_IPCOMP_LEVEL		63  /* int; compression used (NAE only) */
...
#define IP_TCPAO_MKT_CURRENT        26
#define IP_TCPAO_MKT_RNEXT          27
#define IP_TCPAO_MKT_SNEXT          28
#define IP_TCPAO_CURRENT_KEY        29
#define IP_TCPAO_RNEXT_KEY          30
#define IP_TCPAO_SNEXT_KEY          31
#define IP_TCPAO_RCV_KEYIDS         32
#define IP_TCPAO_USE_MKT            33
#define IP_TCPAO_ICMP_ACCEPT        34
...
/***** IP_IPPROTO_UDPLITE level socket options: *****/
#define IP_UDPLITE_SEND_CSCOV    10 /* Number of octets that must be
...
/* IP_SOL_MIPC level options */
#define IP_SOL_MIPC                        50

#define IP_MIPC_SO_TXBUFS                  0
#define IP_MIPC_SO_MTU                     1
#define IP_MIPC_SO_CONN_TIMEOUT            8
#define IP_MIPC_SO_SEND_TIMEOUT            9
#define IP_MIPC_SO_RECEIVE_TIMEOUT         13
#define IP_MIPC_SO_RXBUFS                  14
...
#define IP_SO_X_STACK_IDX         0x1030  /* int; set/get the stack instance
...
#define IP_IPSEC_AUTH           0             /* Authentication level */
#define IP_IPSEC_ESP_TRANS      1             /* ESP transport level */
#define IP_IPSEC_ESP_NETWORK    2             /* ESP network (encapsulation) level */
#define IP_IPSEC_IPCOMP         3             /* Compression level */
...
#define IP_IPSEC_LEVEL_BYPASS      0x00    /* Bypass policy altogether */
#define IP_IPSEC_LEVEL_NONE        0x00    /* Send clear, accept any */
#define IP_IPSEC_LEVEL_AVAIL       0x01    /* Send secure if SA available */
#define IP_IPSEC_LEVEL_USE         0x02    /* Send secure, accept any */
#define IP_IPSEC_LEVEL_REQUIRE     0x03    /* Require secure inbound, also use */
#define IP_IPSEC_LEVEL_UNIQUE      0x04    /* Use outbound SA that is unique */
#define IP_IPSEC_LEVEL_DEFAULT     IP_IPSEC_LEVEL_AVAIL
...
#define IP_X_SIOCGINTR      IP_IOW(SOCK, 11, W, int) /* Clear all pending EINTR on sockets owned by
                                                        the caller */
#define IP_X_SIOCINURG      IP_IOR(SOCK, 12, R, int) /* Returns 1 if the socket is in urgent mode */
#define IP_X_SIOCTOMARK     IP_IOR(SOCK, 13, R, int) /* Returns the number of octet to the
                                                        out-of-band character. Only valid if
                                                        IP_X_SIOCINURG returns 1 */

/* The debug value has no logical effect at all, it is just an integer
   that is stored in the global data segment of the stack. */
#define IP_X_SIOCSDEBUG     IP_IOW(SOCK, 14, W, int) /* Set the current stack debug value */

#define IP_X_SIOCGDEBUG     IP_IOR(SOCK, 14, R, int) /* Get the current stack debug value */

#define IP_SIOCSNDASYNC     IP_IOW(SOCK, 15, W, int) /* Set synchronous flag which is checked in ipcom_sendmsg() */
/* IP_SIOCSSNDMSGAYNC is the original, deprecated name for IP_SIOCSNDASYNC */
#define IP_SIOCSSNDMSGAYNC  IP_IOW(SOCK, 15, W, int)
...
#define IP_SIOCSIFBRDADDR   IP_IOWR(INET,  4, W, struct Ip_ifreq) /* Set broadcast address. */
...
#define IP_SIOCXGIFADDR_IN6   IP_IOWR(INET6, 6, R, struct Ip_in6_aliasreq) /* Get interface IPv6 address '' */
#define IP_SIOCGIFADDR_IN6    IP_IOWR(INET6, 7, R, struct Ip_in6_ifreq)
...
#define IP_SIOCUARP         IP_IOWR(ARP, 8, W, struct Ip_arpreq) /* Send an unsolicitated ARP response
                                                                    to the protcol and hardware address
                                                                    specified by the argument using the
                                                                    primary address of the local interface
                                                                    as source */
...
#define IP_SIOCGIFCONF      IP_IOWR(NETIF, 21, R, struct Ip_ifconf) /* Get interface list. */
...
#define IP_SIOCADDMULTI     IP_IOWR(NETIF, 29, W, struct Ip_sockaddr)
#define IP_SIOCDELMULTI     IP_IOWR(NETIF, 30, W, struct Ip_sockaddr)
/* Linux style HW ioctl's */
#define IP_SIOCGIFHWADDR    IP_IOWR(NETIF, 31, R, struct Ip_ifreq)  /* Get interface name */
#define IP_SIOCGIFRXIDX     IP_IOWR(NETIF, 32, R, struct Ip_ifreq)  /* Get default RX stack instance */
#define IP_SIOCSIFRXIDX     IP_IOW(NETIF, 33, W, struct Ip_ifreq)   /* Set default RX stack instance */

/* Linux style tunnel ioctl's */
#define IP_X_SIOCDELTUNNEL  IP_IOWR(NETIF, 40, W, struct Ip_ifreq)  /* Del tunnel */
#define IP_X_SIOCADDTUNNEL  IP_IOWR(NETIF, 41, W, struct Ip_ifreq)  /* Add tunnel */
#define IP_X_SIOCGETTUNNEL  IP_IOWR(NETIF, 42, R, struct Ip_ifreq)  /* Get tunnel */
#define IP_X_SIOCCHGTUNNEL  IP_IOWR(NETIF, 43, W, struct Ip_ifreq)  /* CHG tunnel */

/* proprietary ioctls: */
#define IP_SIOCXDETACH       IP_IOWR(NETIF, 50, W, struct Ip_ifreq) /* Detach interface. */
#define IP_SIOCXATTACH       IP_IOWR(NETIF, 51, W, struct Ip_ifreq) /* Attach a new physical interface to the stack
                                                                       "ifr_name" is the device driver name
                                                                       "ifr_ifru.ifru_newname" is the name of the
                                                                       attached device, may be an empty string
                                                                       if "ifr_name" should be used as name */
#define IP_SIOCXGDHCPRUNNING IP_IOWR(NETIF, 52, R, struct Ip_ifreq) /* Get DHCP status. */
#define IP_SIOCXSDHCPRUNNING IP_IOWR(NETIF, 53, W, struct Ip_ifreq) /* Enable(1)/Disable(0) DHCP. */
#define IP_SIOCGIFPRIVATE    IP_IOWR(NETIF, 54, R, struct Ip_ifreq) /* Get private interface data */
#define IP_SIOCSIFPRIVATE    IP_IOWR(NETIF, 55, W, struct Ip_ifreq) /* Set private interface data */

/* MACsec SecY specific ioctl */
#define IP_SIOCXSECY    		IP_IOWR(NETIF, 58, W, struct Ip_secyreq)
...
#define IP_SIOCGROUTETABNAME IP_IOWR(RTAB, 6, R, struct Ip_sioc_route_table) /* Map a route table name to VR and table ID */
...
#define IP_SIOCIFDESTROY    IP_IOWR(NETIF, 18, W, struct Ip_ifreq)   /* Destroy a pseudo interface (like vlan) */
#define IP_SIOCSETVLANPRI   IP_IOWR(NETIF, 19, W, struct Ip_ifreq)  /* Set vlan priority for a virtual LAN interface,*
                                                                     'ifru_data' must point to a struct Ip_vlanreq */

/* proprietary VLAN stacking ioctls: */
#define IP_SIOCSETVLANP IP_IOWR(NETIF, 64, W, struct Ip_ifreq)  /* Set VLAN stacking for an ethernet interface, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
#define IP_SIOCDELVLANP IP_IOWR(NETIF, 65, W, struct Ip_ifreq)  /* Delete VLAN stacking for an ethernet interface, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
#define IP_SIOCSETVLANPVID IP_IOWR(NETIF, 66, W, struct Ip_ifreq)  /* Set PVID for an ethernet interface, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
#define IP_SIOCSETVLANPRIMAP IP_IOWR(NETIF, 67, W, struct Ip_ifreq)  /* Set VLAN priority map for a customer edge/network VLAN port, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
#define IP_SIOCSETVLANINRULE  IP_IOWR(NETIF, 68, W, struct Ip_ifreq)  /* Set vlan ingress rule (Admit-ALL/Admit-Tag/Admit-Other) for a LAN stacking port, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
#define IP_SIOCSETVLANOUTRULE IP_IOWR(NETIF, 69, W, struct Ip_ifreq)  /* Set vlan egress rule (Tagged/Untagged) for a LAN stacking port, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
#define IP_SIOCGETPVLAN   IP_IOWR(NETIF, 70, R, struct Ip_ifreq)  /* Get vlan information for a VLAN stacking port, *
                                                                     'ifru_data' must point to a struct Ip_vlanreq */
...
#define IP_SIOCROHCADDIF    IP_IOWR(BASE, 59, W, struct Ip_rohcreq)  /* Add a monitoring interface */
#define IP_SIOCROHCDELIF    IP_IOWR(BASE, 60, W, struct Ip_rohcreq)  /* Delete a monitoring interface */
#define IP_SIOCROHCADDIFPROFILE    IP_IOWR(BASE, 61, W, struct Ip_rohcreq)  /* Add a profile on a monitoring interface */
#define IP_SIOCROHCDELIFPROFILE    IP_IOWR(BASE, 62, W, struct Ip_rohcreq)  /* Delete a profile on a monitoring interface */
#define IP_SIOCSROHCCID     IP_IOWR(BASE, 63, W, struct Ip_rohcreq) /* Set CID */

/* proprietary VLAN ioctls */
#define IP_SIOCSETSTPID     IP_IOWR(BASE, 65, W, struct Ip_vlanreq) /* Set STPID */
#define IP_SIOCGETSTPID     IP_IOWR(BASE, 66, R, struct Ip_vlanreq) /* Get STPID */
...
#define IP_IFF_ALLMULTI      0x0200  /* Receive all multicast packets */
...
/* Need them for compat/bond drivers */
#define IP_IFF_SLAVE         0x10000
#define IP_IFF_MASTER        0x20000

/* For bridged interfaces */
#define IP_IFF_BRIDGED       0x80000 /* Bridged Interface <read only>* (*except by bridge code). */
...
#define IP_SHUT_CLOSE   0x3     /* socket close event */
#endif
...
#define IP_IPOPT_LSRR      (3  | IP_IPOPT_CONTROL | IP_IPOPT_COPY)     /* Loose source route */
#define IP_IPOPT_TIMESTAMP (4  | IP_IPOPT_MEASUREMENT) /* Timestamp */
#define IP_IPOPT_RR        (7  | IP_IPOPT_CONTROL)     /* Record route */
#define IP_IPOPT_SSRR      (9  | IP_IPOPT_CONTROL | IP_IPOPT_COPY)     /* Strict source route */
...
typedef struct Ipnet_packet_socket_struct
{    
    Ip_u32   in_if;       /* Interface to use for income packets (set by bind()) */
}
Ipnet_packet_socket;
...
/* 
 * Helper for accessing IPv4 address when it is
 * stored in the union as an IPv4-mapped IPv6 address.
 */
#ifdef IPCOM_USE_INET6
#define IP_ADDR_UN_IP4(u) (u.in6.in6.addr32[3])
#else
#define IP_ADDR_UN_IP4(u) (u.in.s_addr)
#endif
...
struct Ip_sockaddr_storage
{
    ...
    Ip_u8             ss_len;
#endif
    Ip_sa_family_t    ss_family;    /* address family: AF_xxx value */
...
struct Ip_msghdr
{
    ...
    Ip_socklen_t     msg_namelen;    /* size of address */
    struct Ip_iovec *msg_iov;        /* scatter/gather array */
    int              msg_iovlen;     /* # elements in msg_iov */

    void            *msg_control;    /* ancillary data */
    Ip_socklen_t     msg_controllen; /* ancillary data buffer len */
...
struct Ip_cmsghdr
{
    Ip_socklen_t    cmsg_len;    /* Length in bytes, including this structure */
...
#define IP_CMSG_SPACE(len) \
    (Ip_socklen_t)(IP_CMSG_ALIGN(sizeof(struct Ip_cmsghdr)) + IP_CMSG_ALIGN(len))

/* Length to the end of the ancillary data */
#define IP_CMSG_LEN(len) \
    (Ip_socklen_t)(IP_CMSG_ALIGN(sizeof(struct Ip_cmsghdr)) + len)
...
#define IP_ATF_EXTERNAL     0x400       /* Timer Management is driven by something else */
#define IP_ATF_GATEWAY      0x800       /* This neighbour is used as a gateway in a DST cache */
#define IP_ATF_SILENT       0x1000      /* Do not propagate netlink messages */
...
#if defined(_WRS_CONFIG_EPOLL)
typedef void (*Ipcom_socket_epollcb)(struct Ipcom_socket_struct *sock,
                                     int how);
#endif
...
#if defined(_WRS_CONFIG_EPOLL)
    Ipcom_socket_epollcb  ep_event_cb;
#endif
...
#if defined(IPNET_USE_VLAN_STACKING) || defined(IPCOM_USE_FORWARDER_VLAN_STACKING)
/*
 *===========================================================================
 *                    Ip_pvlanfwd
 *===========================================================================
 * port VLAN forwarding structure for VLAN ioctl IP_SIOCGETPVLAN.
 */
typedef struct Ip_pvlanfwd_ports_struct
{
    Ip_u16  cvid;	    /* C-VID for SC VLAN port */
    Ip_u16  num_fwd_ports;  /* number of VLAN forwarding ports */
    char    fwd_ports[3][IP_IFNAMSIZ];  /* port list */
}
Ip_pvlanfwd_ports;
 ...
 * port VLAN forwarding structure for VLAN ioctl IP_SIOCGETPVLAN.
 */
typedef struct Ip_pvlanfwd_struct
{
    Ip_u16  vid;                   /* VID */
    Ip_u16  svid;                  /* S-VID for CS-VLAN */
    Ip_u8   priority[8];           /* priority mapping */
    Ip_u16  num_vlans;  /* number of VLANs. */
			/*  1 for S/C/CS VLAN port, multiple for SC VLAN port */
    Ip_pvlanfwd_ports  port_list[5];
}
Ip_pvlanfwd;
#endif
 ...
 *                    Ip_vlanreq - ioctl
 *===========================================================================
 * Configuration structure for VLAN ioctls.
 */
struct Ip_vlanreq
{
    char    vlr_parent[IP_IFNAMSIZ];
    Ip_u16  vlr_tag;  /* 12-bit vlan id, 1..4094, 0 for undefined, */
    Ip_u16  vlr_pri;  /* 3-bit class of service, 0..7 */
#if defined(IPNET_USE_VLAN_STACKING) || defined(IPCOM_USE_FORWARDER_VLAN_STACKING)
    Ip_u16  vlr_type; /* port VLAN type */
    Ip_u16  vlr_stag; /* 12-bit service vid, 1..4094, 0 for undefined, */
    Ip_u16  vlr_inrule; /* VLAN ingress rule, admit-all/admit-tag/admit-other */
    Ip_u16  vlr_outrule; /* VLAN egress rule, tagged/untagged */
    Ip_u16  vlr_spri;   /* 3-bit priority to be mapped from C-VLAN to S-VLAN */
    Ip_u16  vlr_stpid;  /* 16 bit service TPID */
    Ip_u16  num_vlans;   /* number of VLANs -- for showing */
    Ip_pvlanfwd    pvlan_fwd[10];
			 /* VLAN forwarding info -- for showing */
#endif
};
 ...
 */
struct Ip_secyreq {
	char    if_name[IP_IFNAMSIZ];             /* if name, e.g. "eth0" */
	Ip_u32	command;
	Ip_u8	data[256]; /* Length and contents are command specific */
};
...
#define IP_NBBY             8                         /* bits per byte */
#define IP_NFDBITS          (sizeof(Ip_fd_mask) * 8u) /* bits per mask */
#define ip_howmany(x, y)    (((x)+((y)-1))/(y))

typedef struct Ip_fd_set_struct
{
    Ip_fd_mask fds_bits[ip_howmany(IP_FD_SETSIZE, IP_NFDBITS)];
}
Ip_fd_set;

#define __IP_FD_BIT(fd) ((Ip_fd_mask)1 << ((Ip_fd_mask)(fd) % (Ip_fd_mask)IP_NFDBITS))

#define IP_FD_ZERO(pfdset)      \
    ipcom_memset(pfdset, 0, sizeof(*pfdset));
#define IP_FD_CLR(fd, pfdset)   \
    ((pfdset)->fds_bits[((Ip_size_t)(fd))/IP_NFDBITS] &= ~__IP_FD_BIT(fd))
#define IP_FD_ISSET(fd, pfdset) \
    ((pfdset)->fds_bits[((Ip_size_t)(fd))/IP_NFDBITS] & __IP_FD_BIT(fd))
#define IP_FD_SET(fd, pfdset)   \
    ((pfdset)->fds_bits[((Ip_size_t)(fd))/IP_NFDBITS] |= __IP_FD_BIT(fd))
#endif

...
/*
 * Copyright (c) 2004, 2007-2010, 2013-2014 Wind River Systems, Inc.
 *
...
--------------------
15oct13,h_k  cleaned up header inclusion dependencies.
07oct10,jmp  Fixed TRC_MEM_INST_READ() macro to call
...
11feb10,rlp  Added vxdbgLibP header file.
07jul09,rlp  Replaced VXDBG_MEM_READ macro with VXDBG_MEM_WIDTH_READ
             (WIND000171075).
13may09,jpb  Updated for LP64 support.
27aug08,jpb  Renamed VSB config file.
24jun08,jpb  Added include path for kernel configurations options set in
             vsb.  Renamed _WRS_VX_SMP to _WRS_CONFIG_SMP.
30apr07,jmp  added TRC_MEM_INST_READ() and TRC_INST_CMP() macros.
14may04,zl   reordered TRC_LIB_FUNCS fields.
02apr04,jmp  added pc argument to TRC_LVL_ARGS_GET().
19mar04,zl   updated for user build.
18feb04,zl   created
*/
...
#if (defined(_WRS_CONFIG_SMP) && defined(_WRS_CONFIG_VXDBG))
#include <private/vxdbgLibP.h>
#endif	/* _WRS_CONFIG_SMP && _WRS_CONFIG_VXDBG */
...
#else	/* _WRS_CONFIG_SMP && _WRS_CONFIG_VXDBG */

...
{
    Ipcom_spinlock lock;            /* Lock protecting all members in Ipnet_nat_data */
#ifdef IP_DEBUG
    Ip_pid_t       locked_by;       /* current holder of NAT lock */
#endif
    struct Ipnet_timeos_struct *timeos; /* Timeout set */
...
typedef struct Ipnet_nat_rule_struct
{
    ...
    void      *proxy_cookie;
#ifdef IPNET_NAT_SUPPORT_MI
    Ipcom_spinlock       lock;           /* Lock protecting all members in Ipnet_nat_rule */
    Ip_pid_t             locked_by;      /* current holder of NAT_RULE lock */
#endif
...
struct Ipnet_nat_mapping_inner
{
    ...
    Ip_u32               dstmap_addr;    /* New destination address */
#ifdef IPNET_USE_NAT_PT
...
typedef struct Ipnet_nat_mapping_struct
{
    ...
    Ipnet_timeout        tmo;            /* Embedded timeos timeout */
    Ipnet_nat_rule      *rule;           /* Reference to the rule */
    Ipnet_nat_proxy_func proxy_func;     /* Proxy function */
    void                *proxy_cookie;   /* Proxy cookie */
#ifdef IPNET_NAT_SUPPORT_MI
    Ipcom_spinlock       lock;           /* Lock protecting all members in Ipnet_nat_mapping */
    Ip_pid_t             locked_by;      /* current holder of NAT_MAPPING lock */
#endif
...
#ifdef IPNET_DEBUG
IP_GLOBAL Ip_bool ipnet_nat_is_locked(void);
#endif /* IPNET_DEBUG */
IP_GLOBAL void ipnet_nat_lock(void);
IP_GLOBAL void ipnet_nat_unlock(void);

#ifdef IPNET_NAT_SUPPORT_MI
IP_GLOBAL Ip_bool ipnet_nat_mapping_is_locked(Ipnet_nat_mapping *nat_mapping);
IP_GLOBAL void ipnet_nat_mapping_lock(Ipnet_nat_mapping *nat_mapping);
IP_GLOBAL void ipnet_nat_mapping_unlock(Ipnet_nat_mapping *nat_mapping);


IP_GLOBAL Ip_bool ipnet_nat_rule_is_locked(Ipnet_nat_rule *nat_rule);
IP_GLOBAL void ipnet_nat_rule_lock(Ipnet_nat_rule *nat_rule);
IP_GLOBAL void ipnet_nat_rule_unlock(Ipnet_nat_rule *nat_rule);
...
IP_GLOBAL void   ipnet_nat_update_mapping(Ip_bool incoming,
                                          Ipnet_nat_mapping *nat_mapping,
                                          Ipnet_nat_tuple *nat_tuple);

IP_GLOBAL Ip_s32 ipnet_nat_match_rule(Ip_bool incoming,
...
IP_GLOBAL Ip_s32 ipnet_nat_output_hook(Ipcom_pkt **pktp);
IP_GLOBAL Ip_s32 ipnet_nat_input_hook(Ipcom_pkt **pktp);

IP_GLOBAL Ipnet_nat_mapping *ipnet_nat_add_mapping(Ip_bool incoming,
                                                   Ipnet_nat_rule *nat_rule,
                                                   Ipnet_nat_tuple *nat_tuple,
                                                   Ip_u32 timeout,
...
IP_GLOBAL Ipnet_nat_mapping *ipnet_nat_find_mapping(Ip_bool incoming,
                                                    Ipcom_pkt *pkt,
                                                    Ipnet_nat_tuple *nat_tuple);
...
#ifdef IPNET_USE_NAT_PT
IP_GLOBAL Ip_s32 ipnet_nat_pt_translate(Ip_bool incoming,
                                        Ipnet_nat_mapping *nat_mapping,
                                        Ipcom_pkt **pktp,
                                        Ipnet_nat_tuple *nat_tuple);
IP_GLOBAL Ip_s32 ipnet_nat_pt_output_hook(Ipcom_pkt **pktp);
#endif

...
/* Copyright 1984-2005, 2006-2011, 2015 Wind River Systems, Inc. */
/*
...
--------------------
10sep15,lyj  Fix V7STO-427 callrpc() can close socket file descriptor twice
21jun11,sjz  Improve NFS performance for the requirement WIND00236547.
29apr10,pad  Moved extern C statement after include statements.
15jan10,y_t  Add LP64 support.
21jul05,vvv  fixed C++ build problem (SPR #99889)
22sep92,rrr  added support for c++
07sep92,smb  added includes of sys/times.h, rpc/xdr.h, rpc/auth.h
26may92,rrr  the tree shuffle
             -changed includes to have absolute path from h/
04oct91,rrr  passed through the ansification filter
             -fixed #else and #endif
             -changed copyright notice
01may01,elh  removed clnt_tcpInit.
10jan91,shl  fixed prototype of callrpc(), included in.h.
25oct90,dnw  changed clnt_tcpInit from int to void.
24oct90,shl  commented out redundant function declarations.
05oct90,shl  added ANSI function prototypes.
             added copyright notice.
26oct89,hjb  upgraded to release 4.0
*/

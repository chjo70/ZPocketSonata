...
/*
 * Copyright (c) 1991-1992, 2001, 2003-2006, 2009-2011, 2014, 2017
 * Wind River Systems, Inc.
 *
 * The right to copy, distribute, modify, or otherwise make use
 * of this software may be licensed only pursuant to the terms
 * of an applicable Wind River license agreement. No license to
 * Wind River intellectual property rights is granted herein.
 * All rights not licensed by Wind River are reserved by Wind River.
*/
...
31jan14,to   do not define fpos_t here for C99, asm file protection
02c,27jan11,pad  Do no include stdint.h when _POSIX_C_SOURCE is defined.
02b,27jul10,jpb  Added include of _Vx_exit_code_t type.
02a,16jun10,pcs  Add new data type _Vx_ticks_t
01z,18may10,pad  Moved extern C statement after include statements.
01y,25jan10,d_c  SMP M-N updates: add phys_cpuset_t data type
02a,13jan10,jpb  Added vsbConfig.h to pick up _WRS_CONFIG_LP64.
01z,02oct09,pad  Removed macros related to ANSI types int8_t, uint8_t, int16_t,
		 uint16_t, int32_t, uint32_t, int64_t and uint64_t. Those types
		 are now defined in stdint.h.
01y,19feb09,pcs  Add new datatype _Vx_usr_arg_t.
01x,22jun06,mmi  Use include base type file for cpuset_t and atomic_t.
01w,14mar06,mil  Use include base type file for ssize_t and time_t.
01v,01mar06,pes  Split out base type files.
01u,22feb06,pes  Move pid_t typedef.
01t,10feb06,jlk  Added blksize_t and blkcnt_t
01s,03feb06,jlk  Changed dev_t to a unsigned long from a short.
01r,23jan06,mil  Updated for POSIX namespace conformance (P2).
01q,07dec05,mcm  Adding macro protection for the std. integer types.
...
#if !defined(__RTP__) && !defined(_C99)
#ifdef _TYPE_fpos_t
#define _FPOS_T
_TYPE_fpos_t;
#undef _TYPE_fpos_t

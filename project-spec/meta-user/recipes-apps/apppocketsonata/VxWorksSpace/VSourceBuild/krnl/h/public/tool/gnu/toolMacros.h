...
18dec06,aeg  added _WRS_FUNC_NORETURN
07jun06,jpb  Updated for POSIX namespace conformance.
...
02oct04,mcm  Fixing definition of _WRS_ABSOLUTE_ for Pentium.
25aug04,h_k  updated _WRS_ABSOLUTE for the arches which require
             specific semantics, such as arm and sh. (SPR #100726)
30jul04,mcm  Undefining WRS_GNU_VAR_MACROS since GCC 3.3.2 supports the
             ANSI syntax
17mar04,dat  remove leading underscore from _absSymbols_xxx (95052)
05mar04,dat  fix abs symbols
05feb04,dat  add macros for _WRS_ABSOLUTE
26nov03,dat  Adding INLINE and DEPRECATED
16oct03,dat  New macros for INLINE both C and ASM
...
#define _WRS_UNINIT_WARNING_OVERRIDE(var)       var = var

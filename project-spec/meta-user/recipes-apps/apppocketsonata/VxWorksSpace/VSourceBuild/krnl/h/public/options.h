...
#    include <stdbool.h>
#  else
     typedef enum { false = 0, true = 1 } VALUE_BOOL;
#    define bool _Bool
...
typedef union {
    ...
    unsigned long       argEnum;    /*< as an enumeration value*/
    unsigned long       argIntptr;  /*< as an integer big enough to hold pointer*/
...
struct options {
    ...
    /* "no-preset".  Includes all user specified options, plus a few8*/
...
extern unsigned long optionEnumerationVal(tOptions*, tOptDesc*, char const * const *, unsigned int);

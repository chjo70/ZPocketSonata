...
/* Copyright 1984-2000, 2010 Wind River Systems, Inc. */
/*
...
02k,14jan00,ham  redefined mem_* to KHEAP_* for PD support.
02j,24jul96,vin  removed INADDR_LOOPBACK since it is defined netinet/in.h
...
#define mem_alloc(bsize)	KHEAP_ALLOC(bsize)
#define mem_free(ptr, bsize)	KHEAP_FREE(ptr)

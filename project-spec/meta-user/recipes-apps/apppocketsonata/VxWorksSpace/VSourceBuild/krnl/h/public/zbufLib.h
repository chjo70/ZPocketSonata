...
extern ZBUF_SEG	zbufInsertBuf (ZBUF_ID zbufId, ZBUF_SEG zbufSeg, int offset,
		    caddr_t buf, int len, VOIDFUNCPTR freeRtn, long freeArg);
extern ZBUF_SEG	zbufInsertBuf64 (ZBUF_ID zbufId, ZBUF_SEG zbufSeg, int offset,
		    caddr_t buf, int len, VOIDFUNCPTR freeRtn, void *freeArg);

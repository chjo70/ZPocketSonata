...
/*
 * Copyright (c) 2004, 2006, 2009-2010, 2017 Wind River Systems, Inc.
 *
...
Folder FOLDER_SYSCTL {
        NAME            SYSCTL components
        SYNOPSIS        This folder contains components that can be used to \
                        support SYSCTL in your project.
        _CHILDREN       FOLDER_OS
...
Component INCLUDE_SYSCTL {
	NAME		SYSCTL
	SYNOPSIS	This component provides SYSCTL function support.

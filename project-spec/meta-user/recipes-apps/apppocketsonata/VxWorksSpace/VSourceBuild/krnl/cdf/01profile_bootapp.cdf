...
/*
 * Copyright (c) 2005-2007, 2010-2012, 2015 Wind River Systems, Inc.
 *
...
12feb15,my_  remove PROFILE_*_BASIC (V7PRO-1583)
03apr12,mze  restrict BOOTAPP to non WRHV_GUEST
18may11,mze  these profiles are not valid for SMP based projects
05jan11,mze  PROFILE_BOOTROM_COMPRESSED_BASIC required for MIPSI64R2
24nov10,mze  add MIPSI64R2
22nov10,mze  changing ifdefs
11nov10,mze  set profile up for only LP64.
21apr10,mze  more changes
20apr10,mze  new profile options
22mar07,jmt  Defect: Remove cache components from bootapp profile.
22feb07,jmt  Defect 88750 - Fix problem with network boot device CDF
             defines
17oct06,jmt  Update Synopsis for use restrictions
11jul06,jmt  Update profile to no longer use default profile.
17aug05,jmt  written
*/

...
/* Copyright 1984-2000, 2016 Wind River Systems, Inc. */
...
22may02,nrv  Adding INCLUDE_MTD_CFIAMD
13nov01,nrv  made use of PRJ_BUILD
09nov01,nrv  merging in T3 version with some cleanup
14dec00,yp   Documentation cleanup
29nov00,yp   derived from ads860 sysTffs.c 01j.
*/
...
long int flFitInSocketWindow 
    (
    unsigned int chipSize,		/* size of single physical chip in bytes */
    int      interleaving,	/* flash chip interleaving (1,2,4 etc) */
    unsigned int windowSize		/* socket window size in bytes */
    )
    {
...
#define	HALF_FORMAT	/* lower 0.5MB for bootimage, upper 1.5MB for TFFS */
    ...
    status = tffsDevFormat (0, (void*)&params);
    return (status);
    }
#endif /* FALSE */

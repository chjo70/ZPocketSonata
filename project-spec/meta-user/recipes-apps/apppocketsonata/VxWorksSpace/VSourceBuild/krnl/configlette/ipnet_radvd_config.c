/*
 * Copyright (c) 2006-2007, 2014-2015 Wind River Systems, Inc.
 *
...
10jul14,rjq  Fix wrong radvd config file. (V7NET-433)
...
14aug06,kch  Added ipnet_radvd_conf_sysvar_ext[] to support per-interface
                 configuration parameters.
03aug06,kch  Renamed INCLUDE_RADVD_CMD to INCLUDE_IPRADVD_CMD.
*/
...
IP_CONST Ipcom_sysvar ipnet_radvd_conf_sysvar[] =
{
    ...
    {"ipnet.inet6.radvd.priority", RADVD_TASK_PRIORITY},

    /*enable debugging or not*/
    {"ipnet.inet6.radvd.debug", RADVD_DEBUG_ENABLE},
...
IP_CONST Ipcom_sysvar_ext ipnet_radvd_conf_sysvar_ext[] =
{
    ...
    /*
     * Specifies the Home Agent Mobile Router support. This parameter can be 
     * specifiedfor each interface that are listed in the RADVD_IFNAME_LIST in 
     * the form of "<ifparam>=<value>". Each pair of "<ifparam>=<value>" is
     * semicolon separated. Default: "0".  E.g. "eth0=0" or "eth0=0;eth1=1".
     */
    { "ipnet.inet6.radvd", "AdvHomeAgentOptMobileRouter",

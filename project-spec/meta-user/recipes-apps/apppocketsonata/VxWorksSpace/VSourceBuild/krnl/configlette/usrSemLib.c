...
/*
 * Copyright (c) 2006-2010, 2015-2016 Wind River Systems, Inc.
 *
...
--------------------
03may15,pfl  set semRWLibMaxReaders to zero when INCLUDE_SEM_READ_WRITE
             is not defined
23apr15,gls  removed _func_semRTake, _func_semWTake, and _func_semExchange
18aug10,s_s  removing shared memory references from semXXXTbl
05feb10,pch  reduced semaphore table size when using small footprint
10nov09,pad  Fixed a manual merge mistake.
05aug09,jpb  Defect# 168954: Added elements to sem tables.
11mar09,pcs  Updated to add support for the LP64 data model.
07jul08,gls  deprecated minimal semaphores
07jan08,gls  fast semaphores renamed to minimal semaphores
12dec07,gls  added fast semaphores
03oct07,jpb  Defect# 106240: Removal of INCLUDE_SEM_OLD.
14sep07,gls  reserved SEM_TYPE_SM_BINARY and SEM_TYPE_SM_COUNTING fields
             in semaphore tables (Defect #00104600)
28jun07,gls  added semGiveNoLockTbl[] and semTakeNoLockTbl[]
28jun07,gls  added _func_semRTake and _func_semWTake
22mar07,gls  move _func_windSemRWDelete and semRWLibMaxReaders here
16mar07,gls  set semRWLibMaxReaders when INCLUDE_SEM_READ_WRITE defined
05feb07,gls  added reader/writer semaphores
11jan06,yvp  written.
*/
...
/*
 * Initialize the system maximum concurrent readers to zero.
 */

UINT semRWLibMaxReaders = 0;
...
WIND_SEM_DELETE_FUNC _func_windSemRWDelete = 
    (WIND_SEM_DELETE_FUNC) windNullReturn;

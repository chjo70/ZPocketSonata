...
/* 
 * Copyright (c) 1997-2005,2010,2014 Wind River Systems, Inc.
 *
...
20may14,sdt  Added wvModuleLibInit support - WB4-3207
28feb14,wzc  move wvRBuffMgrPriorityDefault to rBuff.(WB4-2936)
27feb14,wzc  remove inetLib.h.(WB4-2869)
23feb14,mob  remove wvTsfsUploadPathLib (WB4-2824)
21may10,tcr  64bit adaptation
13jan05,tcr  Fix SPR 101137: WindView upload task priority and stacksize
             should be parameters
15apr04,tcr  rBuff error handler to use error definitions
             change WindView to 'System Viewer'
09oct03,tcr  limit number of logs created
19sep03,tcr  clear logging level before setting a new one
26aug03,tcr  changes for Base6
03mar99,dgp  update to reference project facility instead of config.h
28aug98,dgp  FCS man page edit
13may98,cth  changed minimum buffers, added wvUploadStop to error handling
06may98,dgp  clean up man pages for WV 2.0 beta release
20apr98,cth  changed rbuff options, moved wvEvtLogInit, added
	 wvLogHeaderCreate and Upload
17apr98,cth  added partition id to wvEvtLogInit
15apr98,cth  more clean up
27jan98,cth  cleaned up and made work
18dec97,cth  written
*/
...
file, or socket upload paths (determined by the value of
...
#ifdef	INCLUDE_WINDVIEW_MODULE_CLASS
#   include <private/wvModuleLibP.h>
#endif
#ifdef	INCLUDE_RTP
#   include <private/svRtpLibP.h>
#endif
...
STATUS windviewConfig (void)
    ...
    wvUploadTaskStackSize     = WV_UPLOAD_STACK_SIZE;
    ...
    /*
     * Init WindView module library
     */

#ifdef	INCLUDE_WINDVIEW_MODULE_CLASS
    wvModuleLibInit ();
#endif	/* INCLUDE_WINDVIEW_MODULE_CLASS */
...
* is socket, or file.  Event data is uploaded to the path continuously.
*
...
* of WV_FILE, or WV_SOCK.  The upload path is opened using the

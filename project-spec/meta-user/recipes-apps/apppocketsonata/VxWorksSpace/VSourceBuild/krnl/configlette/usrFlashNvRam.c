...
--------------------
26aug13,sye  fixed sysNvRamGet() for 0 size strlen. (WIND00432118)
11jan13,x_z  written based on wrSbcP5020/nvRamToFlash.c.
*/
...
#include <hwif/flash/vxbFlash.h>
#include <hwif/flash/vxbFlashCommon.h>

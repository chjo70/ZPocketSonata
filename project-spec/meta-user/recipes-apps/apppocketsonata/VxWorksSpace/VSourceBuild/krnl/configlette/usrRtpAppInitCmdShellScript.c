...
/*
 * Copyright (c) 2004, 2009, 2017 Wind River Systems, Inc.
 *
...
--------------------
09jan17,l_z  close script file when execution fails. (V7COR-4460)
20aug09,rlp  Fixed a typo which prevents to launch a shell session

...
26dec06,kch  Removed references to the obsolete coreip virtual stack.
04may05,dlk  Fix SPR #108879. Remove erroneous SEM_Q_FIFO flag
             in semMCreate() and semOpen() calls.
09mar05,dlk  Initialize the logging semaphore here rather than in

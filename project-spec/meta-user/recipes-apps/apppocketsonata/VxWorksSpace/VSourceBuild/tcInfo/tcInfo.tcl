...
set ::tcInfo_PPCE6500diab(CC_ARCH_SPEC) "-tPPCE6500FV:vxworks7 -Xkeywords=0x0 -D_WRS_HARDWARE_FP"
...
lappend tcInfo::ToolFamilies(PPCE6500) gnu
set tcInfo_PPCE6500gnu(TOOL_FAMILY) gnu
set ::tcInfo_PPCE6500gnu(CC) "${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/ccppc"
set ::tcInfo_PPCE6500gnu(CPP) "${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/ccppc -E"
set ::tcInfo_PPCE6500gnu(AS) "${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/ccppc"
set ::tcInfo_PPCE6500gnu(LD) "${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/ldppc"
set ::tcInfo_PPCE6500gnu(NM) "nmppc"
set ::tcInfo_PPCE6500gnu(SIZE) "sizeppc"
set ::tcInfo_PPCE6500gnu(AR) "${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/arppc"
set ::tcInfo_PPCE6500gnu(HEX_FLAGS) ""
set ::tcInfo_PPCE6500gnu(OPTION_INCLUDE_DIR) -I
set ::tcInfo_PPCE6500gnu(OPTION_DEFINE_MACRO) -D
set ::tcInfo_PPCE6500gnu(OPTION_UNDEFINE_MACRO) -U
set ::tcInfo_PPCE6500gnu(OPTION_LANG_C) "-x assembler-with-cpp"
set ::tcInfo_PPCE6500gnu(OPTION_GENERATE_DEPENDENCY_FILE) -MD
set ::tcInfo_PPCE6500gnu(OPTION_DEPEND) "-M -w"
set ::tcInfo_PPCE6500gnu(CC_ARCH_SPEC) "-mcpu=e6500 -D_WRS_HARDWARE_FP -fstrength-reduce -fno-builtin -mhard-float -fno-implicit-fp -mstrict-align"
namespace eval ::tc_PPCE6500gnu { }

set ::tc_PPCE6500gnu::tcname(big_hard) gnu

namespace eval ::tc_PPCE6500gnu::tool_cc {
...
namespace eval ::tc_PPCE6500gnu::tool_cxx {
...
namespace eval ::tc_PPCE6500gnu::tool_as {
...
namespace eval ::tc_PPCE6500gnu::tool_ld {
    ...
    proc buildCmds {flags file} {
	return [list "${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/ldppc $flags -c $file"]
    }
...
namespace eval ::tc_PPCE6500gnu {
	...
	regsub -all -- " -MD" $flags "" cppFlags
	set errorFile [tempFileGet]
	if {[catch {eval exec ${tcWIND_HOME}/compilers/gnu-4.8.1.10${tct2}/ccppc -E -M -w $cppFlags $file 2>  [filenameQuoteIfNecessary $errorFile]} depend]} {
	    set fd [open $errorFile r]
	    set dependError [read $fd]
	    close $fd
	    error "dependency generation failed: $dependError"

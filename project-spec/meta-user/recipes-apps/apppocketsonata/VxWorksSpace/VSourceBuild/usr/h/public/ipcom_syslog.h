...
#define IPCOM_LOG_IPSCTP         (53 << 3)
#define IPCOM_LOG_IPIFPROXY      (54 << 3)
#define IPCOM_LOG_IPCOM_KEY_DB   (55 << 3)
#define IPCOM_LOG_IPWPS     	 (56 << 3)
#define IPCOM_LOG_IPMACSEC     	 (57 << 3)
#define IPCOM_LOG_IPRIPNG        (58 << 3)
#define IPCOM_LOG_IPNTP          (59 << 3)
#define IPCOM_LOG_WRNAD     	 (60 << 3)
#define IPCOM_LOG_IPBRIDGE     	 (61 << 3)
#define IPCOM_LOG_IPFORWARDER  	 (62 << 3)
...
#if defined(IPCOM_USE_CLIB_PROTO)
IP_PUBLIC void

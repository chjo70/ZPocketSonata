 ...
 */
 ...
 #ifndef _NO_WINDRIVER_MODIFICATIONS
  #if !defined(_C_IN_NS) && (201103 <= __cplusplus)
   #define _C_IN_NS 1
  #endif /* _C_IN_NS etc */

  #if defined(__cplusplus) && (201103 > __cplusplus) && defined(__GNUC__)
   #define _MG_GNU_CPLUSPLUS 1
  ...
  /* should stdio.h define va_list (not strictly standard conforming, but many applications allow it)? */
  #define _WR_VA_LIST_IN_STDIO 1
 ...
 #endif /* _MG_GNU_CPLUSPLUS */

		/* DETERMINE MACHINE TYPE */
#if defined(_WRS_CONFIG_LP64) || defined(__LP64__)
  #define _LLONG	1	/* 64-bit longs */
  #define _MACH_PDT     long
#endif /* _WRS_CONFIG_LP64 etc */
 ...
 #elif defined(__ppc__) || defined(_POWER) || defined(_M_PPC) || defined(__ppc)	/* PowerPC */
  #define _D0		0	/* 0: big endian, 3: little endian floating-point */
  #define _DLONG	0	/* 0: 64, 1: 80, 2: 128 long double bits */
  #define _LBIAS	0x3fe	/* 64 long double bits */
  #define _LOFF		4	/* 64 long double bits */
 ...
 #elif defined(_ARM_) || defined(__arm) || defined(__arm__)	/* ARM */
  ...
  #define _DLONG	2	/* 0: 64, 1: 80, 2: 128 long double bits */
  #define _LBIAS	0x3ffe	/* 128 long double bits */
  #define _LOFF		15	/* 128 long double bits */
  #define _FPP_TYPE	_FPP_ARM	/* ARM ARM FPP */
 ...
 #if _CLANG || !defined(_NO_WINDRIVER_MODIFICATIONS)
...
#if !defined(_NO_WINDRIVER_MODIFICATIONS)
 #if defined(_LP64) || defined(__x86_64) || defined(__LP64__)
...
typedef unsigned int _Sizet;
  ...
  #if defined(_MG_GNU_CPLUSPLUS)
   #define __CONFIGURE_EMBEDDED         defined(_ECPP)
   #define __CONFIGURE_EXCEPTIONS       !defined(_NO_EX)
  #endif /* _MG_GNU_CPLUSPLUS */

  #ifndef __CONFIGURE_EMBEDDED
   /* Default to full Standard libraries */
   #define __CONFIGURE_EMBEDDED 0
  #endif

  #ifndef __CONFIGURE_EXCEPTIONS
   /* Works for both EDG and G++ */
   #if __EXCEPTIONS
    #define __CONFIGURE_EXCEPTIONS 1
   #else
    #define __CONFIGURE_EXCEPTIONS 0
   #endif /* __EXCEPTIONS */
  #endif /* __CONFIGURE_EXCEPTIONS */

  #define _HAS_C9X_IMAGINARY_TYPE	0
  #define _IS_EMBEDDED	__CONFIGURE_EMBEDDED
  #define _HAS_EXCEPTIONS               __CONFIGURE_EXCEPTIONS
  ...
  #if defined(_MG_GNU_CPLUSPLUS) && !defined(__RTP__)
...
#define _TLS_QUAL	/* TLS qualifier, such as __declspec(thread), if any */
 ...
 #if defined(_HAS_CPP1X)

 #elif _HAS_CPP0X && (1800 <= _MSC_VER || __EDG__ || _GCC48)
  #define _HAS_CPP1X	1	/* enable C++1X changes */

 #else /* !defined(_HAS_CPP1X) */
  #define _HAS_CPP1X	0	/* disable C++1X changes */
 #endif /* !defined(_HAS_CPP1X) */

 #if defined(_HAS_CPP17)

 #elif _HAS_CPP1X
  #define _HAS_CPP17	1	/* enable C++17 changes */

 #else /* !defined(_HAS_CPP17) */
  #define _HAS_CPP17	0	/* disable C++17 changes */
 #endif /* !defined(_HAS_CPP17) */

 #if defined(_HAS_ALIGNOF)

 #elif _CLANG || 1900 <= _MSC_VER
  #define _HAS_ALIGNOF	1	/* enable alignof */

 #else /* _CLANG || 1900 <= _MSC_VER */
  #define _HAS_ALIGNOF	0	/* disable alignof */
 #endif /* defined(_HAS_ALIGNOF) */

 #if defined(_HAS_CHAR16_T_LANGUAGE_SUPPORT)

 #elif _CLANG || _GCC44 || 403 <= __EDG_VERSION__
  ...
  #if _HAS_CPP0X && (1800 <= _MSC_VER || __EDG__ || _GCC46)
  ...
  #else /* _HAS_CPP0X */
   #define _HAS_ARRAY_OVERLOADS	0	/* disable array range checking */
  #endif /* _HAS_CPP0X */
  ...
  #if _HAS_EXCEPTIONS && _HAS_CPP0X && (404 <= __EDG_VERSION__ || _GCC48)
   #if defined(_NO_WINDRIVER_MODIFICATIONS)
  ...
  #else /* _HAS_CPP0X, etc. */
   #define _HAS_NOEXCEPT	0
  #endif /* _HAS_CPP0X, etc. */

 #endif /* !defined(_HAS_NOEXCEPT) */

 #if _HAS_NOEXCEPT == 0 || !defined(__cplusplus) || _GCC48
  #define _NOEXCEPT
 ...
 #elif (201103 <= __cplusplus) && !defined(_NO_WINDRIVER_MODIFICATIONS)
  #define _HAS_NULLPTR_T	1

 #elif (409 <= __EDG_VERSION__ || _CLANG) && defined(_NO_WINDRIVER_MODIFICATIONS)
  #define _HAS_NULLPTR_T        1
 ...
 #elif _HAS_CPP0X && (405 <= __EDG_VERSION__ || _GCC49)
  #define _HAS_CONSTEXPR	1	/* enable constexpr */

 #elif !defined(_NO_WINDRIVER_MODIFICATIONS) &&  _GCC48
  #define _HAS_CONSTEXPR  1       /* enable constexpr */
 ...
 #elif _HAS_CPP0X && (_GCC45 || 403 <= __EDG_VERSION__)
...
#define _IS_DELETED
  ...
  #if defined(_NO_WINDRIVER_MODIFICATIONS) || _GCC49
 ...
 #elif _HAS_CPP0X && (1800 <= _MSC_VER || _GCC0X || 403 <= __EDG_VERSION__)
...
using namespace _Dinkum_std_c;
  ...
  #if defined(_NO_WINDRIVER_MODIFICATIONS) || !defined(_Restrict)
  #define _Restrict
  #endif
...
#define _TNAMAX	16
 ...
 #define _FN_WIDE	0
  ...
  #else
   /* POSIX requires that _FD_TYPE (as used in fdopen etc.) be of type int */
   #define _FD_TYPE     int
  #endif /* _NO_WINDRIVER_MODIFICATIONS */
 #endif  /* _FD_TYPE */
...
typedef char _Sysch_t;
 ...
 #if defined(_LP64) || defined(__LP64__) || defined(__x86_64)	/* compiler test */
...
_END_EXTERN_C
 ...
 #ifdef __cplusplus
_STD_BEGIN
#if defined(_NO_WINDRIVER_MODIFICATIONS) || (201103 <= __cplusplus)
#ifndef __Uninitialized_declared
#define __Uninitialized_declared
enum _Uninitialized
	{	// tag for suppressing initialization
	_Noinit
	};
#endif /* __Uninitialized_declared */
#endif /* _NO_WINDRIVER_MODIFICATIONS etc. */
...
#if !defined(_NO_WINDRIVER_MODIFICATIONS) && defined(__RTP__) && defined(__GNUC__)
 #define _CSL_USE_WCHAR 1
#endif  /* _NO_WINDRIVER_MODIFICATIONS */

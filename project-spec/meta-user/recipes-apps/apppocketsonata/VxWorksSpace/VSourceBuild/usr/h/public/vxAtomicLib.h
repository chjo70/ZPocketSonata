...
01s,28apr10,pad  Moved extern C statement after include statements.
01r,19jun09,mze  replacing PAD64
01q,20apr09,cww  Fixed size API update
01p,20jan09,jb   Adding x86_64 support
...
#elif	(CPU_FAMILY == SIMLINUX) || (CPU_FAMILY == SIMNT)
#include <arch/simcommon/vxAtomicArchLib.h>
#endif	/* CPU_FAMILY == SIMNT || CPU_FAMILY == SIMNT */

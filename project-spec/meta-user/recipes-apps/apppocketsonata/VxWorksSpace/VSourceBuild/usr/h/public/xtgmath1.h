...
static long double _Complex _Tg_overload \
	...
	{return (fn##l(_Left));}
#define _Tg_cabs \
static float _Complex _Tg_overload _Tg_fabs(float _Complex _Left) \
	{return (cabsf(_Left));} \
static double _Complex _Tg_overload _Tg_fabs(double _Complex _Left) \
	{return (cabs(_Left));} \
static long double _Complex _Tg_overload \
		_Tg_fabs(long double _Complex _Left) \
	{return (cabsl(_Left));}
#define _Tg_r2(fn) \

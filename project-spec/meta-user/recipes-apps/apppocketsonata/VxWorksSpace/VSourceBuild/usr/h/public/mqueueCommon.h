...
/*
 * Copyright (c) 2003, 2005-2006, 2010, 2015 Wind River Systems, Inc.
 *
...
--------------------
26oct15,h_k  changed mqd_t to int from mq_des *. (V7COR-3591)
28apr10,pad  Moved extern C statement after include statements.
13mar06,kk   added _Restrict keyword to mq_setattr() in user land
12feb06,kk   make mq_attr POSIX conformant (SPR# 114488)
05jan06,jln  added definition of _VX_PX_MQ_NAME_MAX and _VX_PX_MQ_PATH_MAX
22aug05,kk   moved RTP or kernel specific prototypes to mqueue.h
07jul05,kk   move MQ_PRIO_MAX into kernel, user level has it in limits.h
14nov03,m_s  code-inspection changes
31oct03,m_s  Written
*/

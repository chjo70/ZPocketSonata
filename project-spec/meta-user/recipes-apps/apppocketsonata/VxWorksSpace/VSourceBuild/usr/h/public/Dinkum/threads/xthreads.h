...
void _Mtx_destroy(_Mtx_t _THR_INDIR);
int _Mtx_current_owns(_Mtx_t _THR_INDIR);
int _Mtx_lock(_Mtx_t _THR_INDIR);
int _Mtx_trylock(_Mtx_t _THR_INDIR);
int _Mtx_timedlock(_Mtx_t _THR_INDIR, const xtime *);
int _Mtx_unlock(_Mtx_t _THR_INDIR);
...
void _Cnd_destroy(_Cnd_t _THR_INDIR);
int _Cnd_wait(_Cnd_t _THR_INDIR, _Mtx_t _THR_INDIR);
int _Cnd_timedwait(_Cnd_t _THR_INDIR,
	_Mtx_t _THR_INDIR, const xtime *);
int _Cnd_broadcast(_Cnd_t _THR_INDIR);
int _Cnd_signal(_Cnd_t _THR_INDIR);
void _Cnd_register_at_thread_exit(_Cnd_t _THR_INDIR,
	_Mtx_t _THR_INDIR, int *);
void _Cnd_unregister_at_thread_exit(_Mtx_t _THR_INDIR);
...
void _Call_onceEx(int *, _Once_callbackEx_t,
	void *);

...
#if defined(IPCOM_NORMPATH) && IPCOM_NORMPATH != 1
#define ipcom_normpath IPCOM_NORMPATH
#elif !defined(IPCOM_NORMPATH)
#define ipcom_normpath normpath
#endif

#if (defined(IPCOM_NORMPATH) && IPCOM_NORMPATH == 1) || defined(IPCOM_USE_CLIB_PROTO)
    IP_PUBLIC char*   ipcom_normpath(const char* path, char* resolved_path);
#endif

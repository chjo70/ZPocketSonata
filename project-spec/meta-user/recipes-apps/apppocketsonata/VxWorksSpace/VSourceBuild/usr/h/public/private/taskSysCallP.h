...
/*
 * Copyright (c) 2010, 2015-2016 Wind River Systems, Inc.
 *
...
--------------------
20apr16,pfl  included taskSysCall.h (V7SP-979)
05nov15,rr   Added new function declarations related to taskCtl (F3906)
13may15,h_k  removed pSafeDeleteFlag from VX_TASK_CTL_DELETE_CMD. (V7COR-2631)
...
extern STATUS   taskStateCtl        (TASK_ID tid, VX_TASK_CTL_CMD command,
                                    void * pArg, size_t  argSize);
extern STATUS   taskParamCtl        (TASK_ID tid, VX_TASK_CTL_CMD command,
                                    void * pArg);
extern STATUS   taskPriCtl          (TASK_ID tid, VX_TASK_CTL_CMD command,
                                    void * pArg);
extern STATUS   taskCpuAffCtl       (TASK_ID tid, VX_TASK_CTL_CMD command,
                                    void * pArg);
extern STATUS   taskVarCtl          (TASK_ID tid, VX_TASK_CTL_CMD command,
                                    long * pVar,long * pValue);
extern STATUS   taskPxAttrCtl       (TASK_ID tid, VX_TASK_CTL_CMD command,
                                    void * pArg);
extern STATUS   _taskWait           (TASK_ID tid, _Vx_ticks_t timeout);
extern STATUS   atomic32Op          (atomic32_t* target, atomic32Val_t oldValue, 
                                    atomic32Val_t value, atomic32Val_t* retVal, 
                                    int atomicSwitch);
extern STATUS   atomic64Op          (atomic64_t* target, atomic64Val_t oldValue, 
                                    atomic64Val_t value, atomic64Val_t* retVal,
                                    int atomicSwitch);
#endif /* !_WRS_KERNEL */

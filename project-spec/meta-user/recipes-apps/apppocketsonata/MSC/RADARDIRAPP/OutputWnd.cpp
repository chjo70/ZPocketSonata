...
BEGIN_MESSAGE_MAP(COutputWnd, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
	ON_MESSAGE(WM_USER_LOGMSG , OnLogMessage )  
END_MESSAGE_MAP()
...
void COutputWnd::LogOutput( TCHAR *pszMessage )
{
	m_wndOutputDebug.AddString( pszMessage );
}
...
LRESULT COutputWnd::OnLogMessage( WPARAM wParam, LPARAM lParam )
{
	char *pStr;

	pStr = (char *) wParam;

	m_wndOutputDebug.AddString( pStr );
